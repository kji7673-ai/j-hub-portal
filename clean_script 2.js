...
function renderCurrentChapter() {
  ...
  if (page.type === "cover" || page.type === "interlude") {
    ...
    let pText = page.text || "";
    let bgStyle = page.image
      ? "background: url(" + page.image + ") center center / cover no-repeat;"
      : "background: #f5f5f7;";

    contentHTML +=
      '<div class="cover-content" style="position:relative; z-index:2; display:flex; flex-direction:column; justify-content:center; align-items:center; height:100%; text-align:center; padding: 10% 8%;">';
    ...
    contentHTML +=
      '<h1 style="font-size:2.5em; font-weight:800; margin-bottom:20px; letter-spacing:-0.5px; line-height:1.2;">' +
      rawTitle +
      "</h1>";
    if (pText)
      contentHTML +=
        '<p style="font-size:1.2em; font-weight:400; color:#555; max-width:80%; line-height:1.6;">' +
        pText +
        "</p>";
    contentHTML += "</div>";
    ...
    if (page.image)
      contentHTML +=
        ...
        currentChapter +
        '" style="max-width: 800px; width: 90%; margin-bottom: 45px;"><img src="' +
        page.image +
        '" alt="sketch"></div>';
    if (page.title)
      contentHTML +=
        '<h2 class="chapter-title" style="margin-bottom:20px;">' +
        page.title +
        "</h2>";
    if (page.text) {
      ...
      paragraphs.forEach((p) => {
        ...
        if (
          ...
          contentHTML +=
            '<div class="table-wrapper" style="width: 100%; overflow-x: auto; padding-bottom: 10px;">' +
            p +
            "</div>";
        } else if (
          ...
          contentHTML +=
            '<blockquote class="pull-quote">' + bqText + "</blockquote>";
        } else if (
          ...
          htmlP = htmlP.replace(/\n/g, "<br>");
          contentHTML +=
            '<p class="body-text" style="line-height: 1.9; margin-bottom: 15px;">' +
            htmlP +
            "</p>";
        }
      });
