...
content = content.replace(
  /"title": "1장. 내가 생각하는 디자인/g,
  '"title": "[디자인 철학] 내가 생각하는 디자인',
);
content = content.replace(
  /"title": "2장. 내가 생각하는 디자인/g,
  '"title": "[디자인 철학] 내가 생각하는 디자인',
);
content = content.replace(
  /"title": "3장. 시지프스의 언덕과/g,
  '"title": "[디자인 철학] 시지프스의 언덕과',
);
...
content = content.replace(
  /"title": "제4장. 완벽한 시스템이 놓친 것들/g,
  '"title": "[현장 기록] 완벽한 시스템이 놓친 것들',
);
content = content.replace(
  /## 제4장. 완벽한 시스템이 놓친 것들/g,
  "## [현장 기록] 완벽한 시스템이 놓친 것들",
);

content = content.replace(
  /"title": "제5장. 26년 현장의 기록/g,
  '"title": "[일기장] 26년 현장의 기록',
);
content = content.replace(
  /## 제5장. 26년 현장의 기록/g,
  "## [일기장] 26년 현장의 기록",
