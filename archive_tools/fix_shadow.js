...
const newOverlay =
  'contentHTML += `<div class="text-overlay" style="position:absolute; top:0; left:0; width:100%; height:100%; z-index:1; display:flex; flex-direction:column; justify-content:center; align-items:center; box-sizing: border-box; background: linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.6));">`;';
...
const newPart =
  "contentHTML += `<p style=\"font-family: var(--font-display, \\'SF Pro Display\\', sans-serif); font-size: 16px; font-weight: 700; color: #4ba3e3; letter-spacing: 0.1em; margin-bottom: 16px; text-transform: uppercase; text-shadow: 0 2px 12px rgba(0,0,0,0.9), 0 1px 4px rgba(0,0,0,0.8);\">${part}</p>`;";
...
const newSub =
  "contentHTML += `<p style=\"font-family: var(--font-body, \\'SF Pro Text\\', sans-serif); font-size: 20px; font-weight: 400; color: #e0e0e0; margin: 0; word-break: keep-all; line-height: 1.5; text-shadow: 0 2px 12px rgba(0,0,0,0.9), 0 1px 4px rgba(0,0,0,0.8);\">${subtitle}</p>`;";
