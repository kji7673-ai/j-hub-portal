...
// 1. Text Replacements
const repl1_old =
  "제가 '아키 시냅스(Archisynapse)'와 같은 AI 시스템을 필사적으로 구축했던 이유는 기술이 좋아서가 아니었습니다. 기계가 할 수 있는 차가운 일들은 기계에게 모두 넘겨주고, 우리 인간만이 할 수 있는 '따뜻한 본질'로 다시 돌아가기 위한 몸부림이었습니다.";
const repl1_new =
  "제가 '아키 시냅스(Archisynapse)'라는 AI 시스템을 필사적으로 구축한 이유는 단 하나입니다. 최신 기술을 좇기 위해서가 아니라, 기계가 가장 잘하는 '차가운 연산'은 기계에게 모두 넘기고, 우리 인간만이 빚어낼 수 있는 '건축의 따뜻한 본질'로 돌아가기 위한 처절한 몸부림이었습니다.";

const repl2_old =
  "그 긴 시간 동안 신입들은 단순 반복적인 PPT 작업이나 방어적인 서류 작업에만 소모되고 있다. 왜 신입들이 오면 설계를 못 할까? 답은 간단하다. 회사가 그들에게 설계의 전체 프로세스를 경험하게 할 시간도, 법규 실무 지식을 체계적으로 가르쳐 줄 여력도 없기 때문이다.";
const repl2_new =
  "하지만 현실은 참혹하다. 건축의 낭만을 안고 입사한 신입들은 단순 반복적인 PPT 작업이나 방어적인 서류 작업에 청춘을 소모하고 있다. 왜 우리 신입들은 스스로 설계를 하지 못할까? 그들의 능력이 부족해서가 아니다. 회사가 그들에게 설계의 전체 프로세스를 경험하게 할 '시간'을 빼앗았고, 실무 지식을 체계적으로 가르쳐 줄 '여력'을 잃어버렸기 때문이다.";

const repl3_old =
  "설계사무소에서 대화형 AI 채팅창(Chat window)에 묻고 답을 얻는 방식은 완전히 틀렸다는 사실을 말이다.";
const repl3_new =
  "건축 실무에서 대화형 AI의 '채팅창(Chat window)'에 질문을 던지고 그 답변을 맹신하는 방식은, 혁신이 아니라 도박이며 완전히 틀린 접근이라는 사실을 말이다.";

// 2. 5060 Exec Conversation
const exec_old =
  '그들은 손가락으로 부드럽게 타일을 넘기며, 처음으로 미소를 지었다. "아, 이제야 우리가 무엇을 해야 하는지 명확히 보이네요." 그 순간은 우리 프로젝트의 거대한 전환점이었다. 아름다움은 단순한 장식이 아니었다. 그것은 복잡함을 정복하고 사람의 마음을 여는, 가장 강력하고 실용적인 비즈니스 무기였다.';
