...
const tagRegex =
  /<div style="background-color: var\(--surface-pearl, #fafafc\); padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; border-left: 3px solid var\(--primary, #0066cc\); font-size: 0.9em; color: var\(--ink-muted-80, #333333\); font-weight: 600; display: inline-block;">\s*<svg[^>]*>.*?<\/svg>\s*\[연결된 철학:[^\]]+\]\s*<\/div><br>/g;
