...
pages.forEach((p) => {
  ...
  // APPENDIX
  if (
    title.startsWith("Part A.") ||
    title.startsWith("Part B.") ||
    title.startsWith("Part C.") ||
    title.startsWith("Part D.") ||
    title.startsWith("Part E.") ||
    title.startsWith("Part F.") ||
    title.startsWith("Part G.") ||
    title.startsWith("부록:") ||
    title.startsWith("[부록]") ||
    title.startsWith("QR코드:") ||
    title.includes("쟁이의 마음:") ||
    title.includes("마치는 글:")
  ) {
    appendix.push(p);
    return;
  }
