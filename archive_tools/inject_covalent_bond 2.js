...
let prologueIndex = bookData.pages.findIndex(
...
const covalentBondPage = {
  type: "text_only",
  title:
    "[디자인 철학] 내가 생각하는 디자인 3: 공유결합(Covalent Bond), 섞이지 않고 새로워지는 것",
...
let design2Index = bookData.pages.findIndex(
  (p) => p.title && p.title.includes("내가 생각하는 디자인 2"),
);
if (design2Index !== -1) {
