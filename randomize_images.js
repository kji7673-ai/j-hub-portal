...
bookData.pages.forEach((page) => {
  ...
  if (page.type === "image_top" || page.type === "image_full") {
    ...
    if (
      page.image &&
      (page.image.includes("sketch") ||
        page.image.includes("diagram") ||
        page.image.includes("flowchart") ||
        page.image.includes("arch") ||
        page.image.includes("user"))
    ) {
      // keep
    } else {
      page.image = getRandomImage();
