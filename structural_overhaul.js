...
for (let p of bookData.pages) {
  ...
  if (cat.includes("1부")) {
    ...
    if (
      p.type === "interlude" ||
      (p.title &&
        (p.title.includes("1부를 마치며") || p.title.includes("2부 시작")))
    ) {
    ...
    if (
      p.type === "interlude" ||
      (p.title &&
        (p.title.includes("2부를 마치며") ||
          p.title.includes("3부를 시작하며")))
    ) {
...
let bridge4 = {
  type: "text_only",
  title: "2부를 마치며",
  text: "수십 년간 쌓인 이 모든 판단과 신뢰의 순간들은, 이제 하나의 거대한 시스템 안에서 어떻게 형태를 갖추게 될까요? 그 해답을 3부에서 펼쳐 보입니다.",
  partCategory: "2부: 철학편",
...
let p3_ch1 = [
  {
    ...
    title: "제1장. 신뢰의 축적 (Theme 1 재해석)",
    text: "테마 1의 자기성찰 에세이들에 나타난 '판단의 순간'들은 시스템 안에서 어떻게 구현되는가? J-Hub는 흔들리는 인간의 판단을 돕기 위해 '선택적 투명성'과 데이터의 축적을 설계했습니다.",
    partCategory: "3부: 미래와 비전",
  },
];
let p3_ch2 = [
  {
    type: "chapter_content",
    title: "제2장. 불완전함의 깊이 (Theme 2 재해석)",
    text: "테마 2에서 마주한 '타인과의 타협'은 완벽한 계산으로는 풀 수 없는 딜레마였습니다. 이 장에서는 인간의 직관과 불완전함이, 차가운 기술을 어떻게 보완하고 온기를 불어넣는지 확인합니다.",
    partCategory: "3부: 미래와 비전",
  },
];
let p3_ch3 = [
  {
    type: "chapter_content",
    title: "제3장. 비판받을 용기 (Theme 3 재해석)",
    text: "테마 3의 현장 혼란 속에서 건축가가 클라이언트·규제·기술 사이에서 선택했던 저항의 방식은, 이제 J-Hub의 리스크 방어 체계와 결정 알고리즘으로 기록되고 학습됩니다.",
    partCategory: "3부: 미래와 비전",
  },
];
let p3_ch4 = [
  {
    type: "chapter_content",
    title: "제4장. 2035년을 준비하며 (Theme 4 재해석)",
    text: "테마 4가 던진 미래 신호들에 대한 응답입니다. AI가 할 수 없는 것은 무엇이며, 그 속에서 건축가의 존엄은 어떻게 지켜지는가. 기술의 시대에 던지는 다섯 가지 다짐입니다.",
    partCategory: "3부: 미래와 비전",
  },
];
...
let heavy_images = [
  "six_stages_timeline.jpg",
  "decision_flowchart.jpg",
  "orchestra_map.jpg",
  "kanban_board.jpg",
  "minefield_risk.jpg",
  "legal_shields.jpg",
