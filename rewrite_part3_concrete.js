...
for (let p of appendixPages) {
  if (
    p.image &&
    (p.image.includes("two_track_ui.jpg") ||
      p.image.includes("decision_flowchart.jpg"))
  ) {
    p.image = null;
  }
}
