...
# 2. Chapter 5 Rewrite (타당성 검토의 비애)
old_ch5 = """건축주나 조합장 입장에서는 답답할 노릇이다. 내 재산이 어떻게 쪼개지고 어떤 방식으로 개발해야 이득인지 정확한 데이터를 원하는데, 돌아오는 대답은 "일단 설계 계약부터 하시면 자세히 풀어드리겠습니다" 뿐이었다."""
...
print("Rewrote the manuscript successfully.")
