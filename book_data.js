var bookData = {
    "pages": [
        ...
        },
        {
            "type": "text_only",
            "title": "철학의 기술화",
            "text": "기술이 우리를 지배하면 '쓸모없는 건축가'가 되지만, 기술이 우리를 돕게 하면 '더 나은 건축가'가 됩니다.<br><br>앞선 에세이들에서 우리는 수많은 갈등과 혼란을 날것 그대로 목격했습니다. 이 부록은 바로 그 혼란의 현장에서, 인간의 온기를 지켜내기 위해 기술이 어떻게 개입해야 하는지에 대한 '개념적 제안'입니다.<br><br>우리가 실험적으로 구축한 디지털 설계 도구(J-Hub)와 AI 알고리즘은, 기계에게 설계를 맡기기 위함이 결코 아닙니다. 그것은 서류와 데이터의 홍수 속에서 인간의 존엄한 판단을 돕기 위해 세운 방어막이자 뼈대입니다.",
            "partCategory": "[부록] 시스템의 기록, J-Hub",
