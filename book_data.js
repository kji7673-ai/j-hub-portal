var bookData = {
    "pages": [
        ...
        {
            "type": "interlude",
            "title": "2단계: 공유결합을 꿈꾸는 설계자의 실제 모습",
            "text": "영화나 드라마 속 건축가는 우아하게 스케치를 하지만, 현실의 설계자는 그리 멋지지 않습니다.<br><br>도면 위에서는 완벽한 '공유결합'을 꿈꾸지만, 실제로는 먹고사는 문제 앞에서 매일 부딪히고 흔들리는 평범한 사람일 뿐입니다.",
            "partCategory": "2부. 삶의 뼈대: 현장의 공유결합",
