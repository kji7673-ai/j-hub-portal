var bookData = {
  pages: [
    ...
    },
    {
      ...
      text: '<div style="background-color: rgba(255, 255, 255, 0.85); padding: 30px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">제1막에서 이론을 다루고,<br>제2막에서 개인의 독립을 강조했으며,<br>제3막에서 관계의 깊이를 탐색한 끝에,<br>제4막에서 우리는 비로소 \'공동체\'에 다다랐습니다.<br><br>도면 위의 선들이 결국 하고 싶은 말은 이것입니다.<br><br>"당신은 혼자가 아닙니다.<br>이 공간은 당신의 삶을 잇는 선이 되고,<br>이 건물은 우리가 함께 만드는 공유결합입니다.<br>누군가는 이 선을 따라 누군가를 만나고,<br>누군가는 이 공간에서 자신의 의미를 찾을 것입니다."<br><br>그렇기에 도면 위의 모든 선은<br>단순한 구조가 아니라,<br>사람과 사람을 잇는 관계의 기록이며,<br>우리가 남기는 작은 희망입니다.</div>',
      partCategory: "",
    },
  ],
};
