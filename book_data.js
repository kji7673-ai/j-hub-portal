var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "text": "26년.<br>\n도면 위에서 숱한 선을 그었고, 현장의 진흙탕에서 무수한 사람을 만났습니다.<br>\n<br>\n처음엔 '훌륭한 건축'을 꿈꿨습니다. 위대한 작품, 기념비적인 건물 말입니다. 하지만 지금 깨닫는 것은, 그 모든 것이 결국 사람 사이의 신뢰에서 비롯된다는 것입니다.<br>\n<br>\n공유결합이란 거창한 이론이 아니었습니다.<br>\n처음에는 그저 도면 위의 디자인 방법론이었습니다.<br>\n빛과 공간, 형태와 흐름이 서로의 빈자리를 채우며 하나의 건축이 되는 원리.<br>\n그 원리를 찾기 위해 26년을 도면 앞에 앉았습니다.<br>\n<br>\n그런데 도면 앞에 오래 앉아 있다 보니, 알게 된 것이 있습니다.<br>\n공간과 공간이 결합하기 전에, 먼저 '나'라는 개체가 단단해져야 했다는 것을.<br>\n<br>\n서울에 올라와 생존에 가까웠던 삶.<br>\n내세울 것 하나 없는 결과물 앞에서의 부끄러움.<br>\n밤새 그은 선이 아침이면 지워지는 허탈함.<br>\n그래도 건축을 놓지 못했던 것은, 이 일이 '사람의 깊이'와 나란히 걸어가는 유일한 일이었기 때문입니다.<br>\n<br>\n쪼개지고 부서지면서도 결국 자기 자신의 무게 중심을 다시 세우는 일.<br>\n그것이 공유결합의 가장 중요한 전제였습니다.<br>\n<br>\n그렇게 혼자서 겨우 서게 된 다음에야, 비로소 타인이 보이기 시작했습니다.<br>\n<br>\n10년을 함께 일해야 하는 정비사업의 사람들.<br>\n각자의 꿈을 안고 한 지붕 아래 모인 공동체의 형, 누나들.<br>\n반말부터 던지는 건축주 앞에서 삼켜야 했던 말들.<br>\n그리고 그 모든 부딪힘 속에서 조금씩 알게 된 것 —<br>\n상대의 잘못이 아니라 내 실력이 부족했다는 것,<br>\n말하지 않아도 전해질 거라는 믿음은 오만이었다는 것,<br>\n끝없이 증명하고 노력해야만 비로소 진심이 가닿는다는 것.<br>\n<br>\n이 책에 담긴 글들은 그 과정에서 흘러나온 투박한 기록들입니다.<br>\n어떤 글은 도면 위의 방법론이고,<br>\n어떤 글은 혼자 버텨낸 밤의 독백이며,<br>\n어떤 글은 타인을 이해하려다 실패하고, 다시 다가선 기록입니다.<br>\n<br>\n돌이켜보면 제가 26년간 도면 위에서 찾고자 했던 것은 결국 하나였습니다.<br>\n나라는 원자가 홀로 단단히 선 채로, 타인이라는 원자와 전자를 공유하며, 어느 쪽도 훼손되지 않는 결합.<br>\n그것이 제가 깨달은 공유결합의 진짜 의미입니다.<br>\n<br>\n이 책을 읽는 누군가가, 내일 누군가를 대할 때<br>\n'저 사람의 불완전함도 내 불완전함처럼 소중한 것이 아닐까'<br>\n라고 잠시라도 생각해 준다면,<br>\n<br>\n저의 26년은 헛되지 않을 것 같습니다.<br>\n<br><br><br>도면 위에 그었던 모든 선들이, 결국 사람과 사람을 연결하는 선이 되길 바랍니다.<br><br>혹은 누군가에게 그 선이 '내가 혼자가 아니구나'라는 따뜻한 확인이 되어줄 수 있다면, 저의 26년 도면 위의 여정은 이제 당신의 손에서 이어질 것입니다.",
            "partCategory": ""
        },
        {
            "type": "cover",
        ...
        },
        {
            "part": "4부: 증언과 성찰",
            "partTitle": "[Theme 1] 현장에서의 갈등",
            "title": "[제도적 공유결합의 실증] 어느 심의 날의 기록",
            "text": "<div style='padding:16px; background:#eef4fa; border-left:4px solid #0066cc; margin-bottom:24px; color:#0066cc;'><strong>이것은 '공유결합의 4가지 층위' 중 네 번째, 자본과 공공의 규제, 그리고 주민의 이해관계가 조율되는 '제도적 공유결합'에 관한 기록입니다.</strong></div>요즘 제가 주로 심의하는 것은 모아타운, 즉 소규모주택정비사업 심의를 보고 있고, 예전에는 도시형생활주택 층수 완화 건을 많이 봐왔습니다.<br><br>건축법은 정치법이라, 정권마다 그리고 그 시기마다 유행하는 사업 방식이 있습니다. 좀 이상하지요. 유행하는 사업 방식이 있다는 것이요.<br><br>아무튼, 도시형생활주택은 소규모 가구 수 증가 추세에 맞추어 다양한 주택 유형의 보급 및 필요에 대한 충족을 위해 만들어진 공동주택의 한 유형입니다. 도시형생활주택은 원룸형, 다세대형, 연립형 등이 있는데, 현재 그 취지에 맞게 원룸형 주택으로 공급되기보다는 다세대 형태로 주로 공급되어집니다. 즉, 기존 다세대주택 유형에서 도시형생활주택으로 옮겨간 것입니다.<br><br>이러한 정책은 발코니 확장 합법화와 맞물려 확장을 고려한 전용면적이 최소화된 평면이 생산(?)되어집니다. 예전 다세대주택에서는 층수가 4층 이하로 되어있다 보니 전용면적만으로도 기본적인 거실과 방의 역할을 할 수 있었으나, 현재는 발코니 확장 전에는 실의 역할을 하지 못하는 것들이 너무 많습니다.<br><br>소규모 가구를 위한 정책이었으나, 다세대 개발업자의 돈벌이 수단이 된 것입니다.<br><br>누군가의 돈벌이 수단이 되었다는 것은 굳이 문제를 삼을 일은 아니나, 작은 대지에 더 많은 세대수를 지을 수 있게 했다면 그와 더불어 입주민을 위한 공동시설 또한 의무 설치하게 했다면 얼마나 좋았을까 싶습니다.<br><br>서로 간에 교류와 소통이 없는 현 주거 공간에서, 소통과 주민 간의 접촉점이 자연스럽게 많이 일어날 수 있는 주민 공동시설, 사랑방이나 편의 시설이 있었다면 좀 더 좋게 되었을 것 같은데 말입니다.<br><br>너무 가까이 있으면 자기만의 공간을 위해 더욱 닫고 사는 게 사람의 본성인데, 조금은 숫자 놀음으로 건축의 정책이 만들어지지 않았으면 좋겠습니다.<br><br><blockquote>좋은 관계를 위해선 그만큼의 여유 공간이 필요합니다. 서로 잘 지낼 수 있고 소통할 수 있는 공간이 생기는 정책이었다면 얼마나 좋았을까? 다세대마다 특색이 있는 사랑방이 있다면 얼마나 좋았을까? 계단의 참이 휴게 테라스가 되면 얼마나 좋았을까? 이런 생각을 해봅니다.</blockquote><br><br>단순히 규제에 맞추는 것이 아니라, 공공의 이익과 자본의 논리 사이에서 절묘한 균형점을 찾아내는 것. 심의라는 제도를 통해 도시와 인간이 타협하는 이 지난한 과정이야말로 살아있는 <strong>'제도적 공유결합'</strong>입니다.",
            "partCategory": "제1막: 공유결합 디자인 방법론",
