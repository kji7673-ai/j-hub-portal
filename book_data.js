var bookData = {
    "pages": [
        ...
        },
        {
            "type": "image_top",
            "title": "찢어진 운동화",
            "text": "<div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\">건축이란 화려한 조감도나 흙먼지 날리는 현장 속에서만 완성되는 것이 아닙니다. 진짜 건축 설계는 사람과 사람의 '만남'에서 시작되며, 그 만남을 어떻게 좋은 관계로 엮어 가느냐에 달려 있습니다.\n<div class=\"footnote-box\">\n<strong>* 조감도</strong>: 새가 하늘에서 내려다본 것처럼 지표면을 넓은 시야로 그린 그림.\n</div>",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 1] 현장에서의 갈등",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
        ...
        },
        {
            "type": "image_top",
            "title": "관계 속의 아름다움",
            "text": "투시도 한 장을 만들 때도 마찬가지입니다. 빛과 그림자, 건물이 놓인 주변 맥락 사이의 미세한 흐름을 읽어내야 합니다. 설계자 스스로 이 '<span class=\"highlight-text\">관계 속의 아름다움</span>'을 정확히 꿰뚫어 보지 못한다면, 결코 좋은 그림을 요구할 수도, 얻어낼 수도 없습니다.<br><br>",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "제3막: 사람을 알아가는 관계성",
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "우리가 이렇게 살아갑니다",
            "text": "<blockquote>적당히 떨어져 있어야 하는데, 우리는 너무 빽빽하게 붙어 있다 보니 외려 문을 굳게 닫고 살아갑니다. 옆 동 사람과는 쉽게 친해져도 바로 벽 하나를 맞댄 옆 호 사람과는 눈조차 마주치기 어려운 것이 우리의 현실입니다.<br><br>건물과 건물 사이에 숨을 쉴 골목이 필요하듯, 사람 사이에도 바람이 통할 한 뼘의 거리가 있어야 비로소 서로를 밀어내지 않고 곁에 머물 수 있으니까요.</blockquote>",
            "image": null,
            "partCategory": "제3막: 사람을 알아가는 관계성",
            "type": "poem",
            "caption": null,
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "우리가 이렇게 살아갑니다",
            "text": "설계하는 사람들 중 간혹 개인의 '절대적인 자기 영역'에 대한 이해가 부족한 경우를 봅니다. 그들은 사람들이 모이기를 기대하며 예쁜 공용 공간을 널찍하게 그려 넣지만, 실상 그곳은 언제나 텅 비어 있습니다. 좁은 복도에서 이웃과 마주치면 반갑게 인사할 것이라 상상하지만, 사람들은 고개를 푹 숙인 채 그저 그 뻘쭘한 찰나가 빨리 지나가기만을 서로를 온전히 바라보기 위해서는 역설적이게도 최소한의 '떨어짐(거리)'이 필요합니다.<br>",
            "image": null,
            "partCategory": "제3막: 사람을 알아가는 관계성",
            "type": "poem",
            "caption": null,
        ...
        },
        {
            "type": "image_top",
            "title": "서계동 현상설계",
            "text": "오랜 세월 주민들에게 불편함의 상징이었던 가파른 단차를 오히려 이 아파트만의 독보적인 명소로 뒤바꾸는 것. 서울에 사는 누구나 한 번쯤 찾아와 사진을 찍고 싶어 하는 매력적인 장소로 만드는 것. 지형의 약점, 주민의 쉼, 그리고 조합의 수익이라는 서로 다른 가치들을 하나의 공간 구조로 단단하게 묶어내는 이러한 설계 방향이 바로 제가 믿는 '공유결합'의 실체입니다.\n비록 수주라는 결과로 이어지진 못했을지라도, 우리는 그 눈 내리는 용산의 언덕에서 건축의 진짜 본질과 단단하게 결합해 있었습니다.<br><br>\n<div class=\"footnote-box\">\n<strong>* 공유결합</strong>: 화학 용어로, 원자들이 전자를 공유하여 형성하는 강력한 결합. 본문에서는 개별 요소들이 모여 단단하고 새로운 건축적 가치를 창출하는 과정을 뜻합니다.\n</div>",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "제4막: 공동체로의 통합, 마음을 짓는 일",
