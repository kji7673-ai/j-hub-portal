var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "text": "제가 왜 '공유결합'이라는 단어를 설계의 중심에 두게 되었는지 고백해야 할 것 같습니다. 제 인생을 관통하는 이 단어는 전혀 상관없어 보이는 세 번의 우연한 기억에서 시작되었습니다.<br><br>첫 번째는 고등학교 1학년 때 만난 친구 정하진입니다. 어느 날 어머니가 부엌에서 \"진아~\" 하고 부르시자, 하진이는 너무나도 다정하게 \"네~\" 하고 대답했습니다. 대구에서 자란 무뚝뚝한 사내아이들의 퉁명스러운 \"왜!\"만 듣고 자란 제게, 그 짧고 따뜻한 대답은 신선한 충격이었습니다. 누군가의 부름에 저토록 다정하게 응답할 수 있구나. 40년이 지난 지금도 그 \"네~\"라는 울림은 선명합니다.<br><br>두 번째는 대학원 시절이었습니다. 길을 걷다 갑자기 머릿속에 번개가 친 것처럼 \"계단! 그래, 계단이다!\" 하고 소리친 적이 있습니다. 상하를 잇고 단절된 층위를 극복하며 공간의 변화를 이끌어내는 존재. 서로 다른 두 공간을 이어주는 매개체의 벅찬 힘을 깨달은 순간이었습니다.<br><br>마지막 세 번째는 어느 날 듣게 된 저명한 물리학자 교수님의 강연이었습니다. 원소의 결합 방식을 설명하며 '이온 결합'과 '공유결합'이라는 단어를 꺼내신 순간, 제 머릿속에서 과거의 그 다정한 \"네~\"라는 대답과 \"계단\"의 깨달음이 하나로 얽혀 폭발했습니다.<br><br>'아, 우리 몸도 결국 공유결합이구나. 그렇다면 나와 타인, 나와 현장의 관계 역시 하나의 커다란 공유결합이구나.'<br><br>사람은 타인의 부름에 다정하게 응답할 수 있고(네~), 단절된 것들을 연결할 수 있으며(계단), 스스로 세상을 잇는 매개체가 될 수 있습니다.<br>각자의 불완전함을 기꺼이 내어주고 서로를 묶어 안정을 찾는 과정. 그날 이후, '공유결합'은 제 건축과 삶을 지탱하는 유일한 나침반이 되었습니다.",
            "part": "1부: 설계의 본질 - 공유결합",
            "partTitle": "건축이라는 세계",
            "partCategory": "1부. 건축의 뼈대: 도면 위의 철학",
        ...
        },
        {
            "type": "image_top",
            "title": "관계 속의 아름다움",
            "text": "우리가 CG 업체에서 받은 이미지가 마음에 들지 않는 이유를 생각해 봅시다. 좋은 참고 이미지를 찾아 \"이 분위기로 만들어 달라\"고 요청해도 늘 어딘가 어색한 이유는, 건축의 아름다움이 단순히 '형태나 색감'만으로 완성되지 않기 때문입니다. 거기에는 가장 중요한 '시간에 대한 이해'가 빠져 있습니다.<br><br>조감도나 투시도라는 것은 결국 어느 특정 시간대의 '빛과 그림자, 그리고 명암'을 포착해 내는 작업입니다. 건물이 대지 위에 놓였을 때 시간의 흐름에 따라 빛이 어떻게 떨어지고 그림자가 어떻게 깊이를 만들어내는지, 그 미세한 명암을 전체적으로 조율할 줄 알아야만 이미지는 비로소 생명력을 가진 진짜 건축물이 됩니다.<br><br>우리가 한국의 미(美)를 말할 때 흔히 '자연스러움'을 이야기합니다. 하지만 이 자연스러움은 그저 자연 그대로 방치된 상태가 아닙니다. 진정한 한국의 미는 <strong>'당연히 있어야 할 곳에, 마땅히 있어야 할 것을 두는 것'</strong>입니다.<br><br>우리가 CG 업체에 조감도나 투시도를 요청할 때도 마찬가지입니다. 건물 주변 맥락의 흐름과 시간, 그리고 그 '관계 속의 아름다움'을 정확히 파악해야 합니다. 이 미세한 관계 설정이 빠지면 이미지가 얼마나 어색해지는지를 스스로 깨닫고, 정확하게 요구할 줄 알아야 합니다.<br><br><div style=\"background-color: #f5f5f7; padding: 24px; border-radius: 12px; margin-top: 32px;\"><p style=\"margin: 0; color: #1d1d1f; line-height: 1.7; font-size: 0.95em;\">실제로 연차가 낮던 시절, <br>제가 CG 업체에 수정 요청을 할 때면 대단히 추상적인 이야기만 늘어놓곤 했습니다.<br>\"이곳은 좀 밝고 따뜻하게 해 주시고, 보는 사람이 딱 기분 좋게 느끼도록 해 주세요.\"<br><br>지금 생각해 보면, <br>그 업체 직원분들이 속으로 무어라 생각했을까요? <br>마치 조물주가 \"빛이 있으라!\" 했더니 빛이 생겨나는 식의 기적을 바란다고 어이없어하지 않았을까요?<br>설계자라면 자신의 의도가 무엇인지, 그리고 그 의도를 어떻게 실현시킬 수 있는지 명확한 관계 설정과 방향성을 먼저 제시할 줄 알아야 합니다.<br><br>사람들과의 관계도 똑같습니다. <br>\"난 당신과 잘 지내고 싶어\"라는 말 한마디 던진다고 저절로 관계가 좋아지는 것이 아닙니다. <br>스스로 상대와의 관계에서 조심스레 간격을 맞추고, <br>때로는 상대를 올바른 방향으로 이끌 줄 아는 구체적인 노력이 필요합니다.<br><br>물론, 이것 역시 결코 쉽지 않은 일입니다.</p></div>",
        ...
        },
        {
            "type": "image_top",
            "title": "본질을 지키는 도구",
            "text": "한때 우리는 시스템과 기계가 인간의 설계를 위협한다고 생각했습니다. 하지만 이제는 다릅니다.<br><br>차가운 자본의 논리와 거친 현장에서, 인간의 온기와 건축의 본질을 잃지 않기 위해 우리는 우리만의 단단한 지지대(시스템)를 구축했습니다. 기계가 사람을 대체하기 위해서가 아닙니다. 기계가 할 수 있는 차가운 계산을 모두 넘겨버리고, 우리는 사람의 온기가 필요한 '진짜 설계'와 '사람을 향한 설득'에 온전히 우리의 시간을 바치기 위함입니다.<br><br>우리의 이 투박한 실험과 기록들이, 훗날 후배들이 서류 더미와 불신에 휩쓸리지 않고 '진짜 건축'에만 집중할 수 있게 하는 단단한 울타리가 되기를 바랍니다.",
            "partCategory": "맺음말",
