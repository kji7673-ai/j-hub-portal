var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "partTitle": "건축이라는 세계",
            "partCategory": "1부. 설계의 본질 – 공유결합",
            "image": "static/images/sketches/111.jpg"
        },
        {
            "type": "text",
            "title": "공유결합의 세 가지 질문",
        ...
        {
            "type": "text",
            "title": "공유결합의 첫 번째 질문: 조율자로서의 기준 세우기",
            "partCategory": "1부. 설계의 본질 – 공유결합",
            ...
            "image": "static/images/sketches/35.jpg"
        },
        {
            "type": "text",
        ...
        {
            "type": "text",
            "title": "공유결합의 두 번째 질문: 서로 다름을 이해하는 것",
            "partCategory": "1부. 설계의 본질 – 공유결합",
            ...
            "image": "static/images/sketches/103.jpg"
        },
        {
            "type": "text",
        ...
        },
        {
            ...
            "text": "<div style=\"text-align: center; max-width: 500px; margin: 0 auto;\">\n<p style=\"text-align: left; line-height: 2.2; font-size: 1.1em; color: #333; margin-top: 40px; margin-bottom: 60px; display: inline-block;\">\n뇌물<br><br>\n뇌물의 ㄴ을<br>\n시계방향으로 180도 돌리면<br>\n괴물이 된다.<br><br>\n일단, 받으면<br>\n시간의 흐름에<br>\n곧 괴물이 되어 돌아온다.<br><br>\n괴물이 될 것들을 조심하자\n</p>\n</div>\n\n<div style=\"margin-top: 40px; padding: 20px; background-color: #f5f5f7; border-radius: 8px; color: #555555; font-size: 14px; line-height: 1.6; border-left: 3px solid #999999;\">LIVE를 잘못 살면 즉, LIVE를 끝에서 다시 배열하면 EVIL이 됩니다.<br>삶을 잘 살아야 하는데... 후회가 많은 삶입니다.<br>그래도, 인생 뭐 있다고 쪼잔하게 받을 바에는 안 받는 게 낫습니다. ㅎㅎ. 농담입니다.</div>",
        ...
        },
        {
            ...
            "text": "오늘의 내가 과거 현장의 진흙탕을 다시 들여다본다.<br><br>시공자와의 갈등, 주민들과의 만남, 피할 수 없었던 수많은 타협의 순간들 속에서<br>나는 비로소 '공유결합'의 진짜 의미를 온몸으로 깨달아가고 있었다.",
            "partCategory": "1부. 설계의 본질 – 공유결합",
        ...
        },
        {
            ...
            "partCategory": "1부. 설계의 본질 – 공유결합",
            "image": "static/images/sketches/74.jpg"
        },
        {
            "type": "text_only",
            "title": "기록의 무게",
            ...
            "partCategory": "1부. 설계의 본질 – 공유결합",
            "image": "static/images/sketches/75.jpg"
        },
        {
            "type": "interlude",
        ...
        },
        {
            ...
            "title": "내가 생각하는 디자인이란?",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
            "image": "static/images/sketches/07.jpg"
        },
        {
            "type": "image_top",
            "title": "내가 생각하는 디자인 1: 존중과 순응",
            "text": "제가 생각하는 디자인은 거창한 것이 아닙니다$2 사물과 사람을 존중하고, 본능을 이해하며, 그 사이의 관계를 엮어내는 일입니다.\n\n**1. 단순화 시킨다: 영역성의 존중**\n개체의 특성을 인정하고 그 개체 간에 질서를 부여하여 통합화합니다. 단, 각 개체의 영역성을 굳건히 인정해야 합니다. 벽에 필요에 의해 생긴 창문도 그 성격을 분명히 하기 위해선 고유의 영역이 필요합니다. 각 디자인 요소들에게 물어보고 그들을 존중해야 합니다. \n너무 작은 요소라 하여 소홀히 해선 안 됩니다. 만약 개체성을 잃을 것 같다면 큰 흐름 속에 포함시키되, 좀 더 강한 특성(색, 모양, 재질 등)을 부여해야 합니다. \n아이폰의 옆면을 보면 은색 테두리에 딱 필요한 만큼의 여백이 선형을 이루고 있습니다. 은색 테두리가 아름다운 것은 바탕 여백이 있기 때문입니다. 적당한 테두리 간격의 아슬아슬함이 쾌감을 일으킵니다. 은하가 아름다운 것은 우주의 어두움이 있기 때문입니다. 디자인은 자신의 감각을 믿는 사람이 아닌, 사람을 알고 작은 사물이라도 존중할 줄 아는 사람이 해야 합니다.",
        ...
        },
        {
            ...
            "image": "static/images/sketches/04.jpg",
            "part": "4부: 증언과 성찰",
        ...
        },
        {
            ...
            "image": "static/images/sketches/71.jpg",
            "part": "4부: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거"
        },
        ...
        },
        {
            ...
            "image": "static/images/sketches/01.jpg",
            "part": "4부: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거"
        },
        {
            "type": "image_top",
            "title": "단순화와 포용력",
            "text": "어떤 개체를 존중하려면, 때로는 그것을 품어주는 넉넉한 바탕이 필요합니다. \"악마는 프라다를 입는다\"는 말처럼, 세련된 프라다의 디자인은 평범함 속에 빛나는 비범함입니다. 이 세련됨이 존재하려면 반드시 평범함이 곁에 있어야 하는 것입니다. \n\n재능이 많은 부하직원들이 능력을 마음껏 발휘하게 하려면, \n윗사람은 오히려 그들의 바탕이되어, 자신의 개성을 뽐내기보다 무색무취하게 넓고 퍼져야 한다. \n\n삼국지에서 관우와 장비가 돋보이는 것은 그들을 품을 수 있는 유비의 포용력이 있었기 때문입니다.\n\nAI라는 거대한 데이터의 바다(단순하고 무색무취한 바탕) 위에서 비로소 인간 건축가의 통찰(관우와 장비의 개성)이 자유롭게 뛰어놀 수 있습니다. \n기계의 단순함을 넉넉히 품어낼 때, 우리의 직관은 비로소 예리하게 빛날 수 있을것입니다.",
            "image": "static/images/sketches/93.jpg",
            "part": "4부: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거"
        },
        ...
        },
        {
            ...
            "text": "그래 <br>그래도 <br>난 붓을 놓을 수가 없습니다. <br><br>내 속을 <br>채운 체액이 <br>한 방울도 남김없이 다 빠져나가고, <br>그곳에 또다시 피 섞인 다른 것으로 저를 채우고 비워내며, <br><br>저를 닮은 것을 세상에 다시한번 내어놓습니다. <br><br>곧 발가벗겨진 채 이리저리 돌려보는 그들의 눈초리에 <br>난 부끄러워 할것이고, <br><br>그 기억에 <br>밤새 뜬눈으로 지새울 것입니다.<br><br>미워도 다시한번이 아닌 <br>그래도 다시한번 힘내어 봅니다.<br><br>그래<br>그렇지<br>저는 쟁이입니다. <br><br>이것을 놓는 순간 <br>다시는 붓을 들 수 없을 것이라는 것을 알기에,<br><br>아련한 추억 속에서<br> '내가 그때 그 길을 계속 걸었다면' 하는 후회로 살아가기엔 <br><br>아직은 이른 것 같습니다. <br><br>그래, 또다시 붓을 들어 <br>저를 다듬어갑니다.<br><br><div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\">아직까지도 매번 하는 설계가 또 언제나 돌아오는 현상설계(수많은 건축가가 사활을 걸고 디자인 경쟁을 펼쳐 단 하나의 당선작을 뽑는 건축 공모전)를 시작한다는 것에 몹시도 망설여지고 피하고 싶은 마음과, 발가벗겨질 것이라는 두려움이 교차합니다. 어린 후배들은 더 하겠지요. 자신의 실력과 능력이 시험받는 느낌을 받을 것이고, 어딘가로 훌쩍 숨고 싶을 것입니다.<br><br>그래도 한참 선배로서 말해주고 싶은 것은, 두려워하지 말라는 것입니다. 포기하지만 않는다면 잘 할 수 있습니다. 그렇게 말해 주고싶습니다.</div>",
            "image": "static/images/sketches/42.jpg",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거"
        },
        {
            "type": "image_top",
            "title": "100년의 기억을 덮는다는 것의 무게",
            "text": "**100년의 삶을 지워버릴 수는 없었다**\n\n어떤 프로젝트는 도면을 그리기 전에 가슴부터 묵직해질 때가 있습니다. 대전의 어느 정비사업장이 그랬습니다.\n\n그 사업지 한가운데에는 100년의 역사를 품은 낡은 시장이 숨 쉬고 있었습니다. 거미줄처럼 얽힌 골목길, 매일 아침 좌판을 까는 상인들의 주름진 손, 그리고 그 시장을 오가며 삶의 희로애락을 나눴을 사람들의 시간들. 단순히 재개발이라는 이름 아래 굴착기으로 밀어버리기엔, 그곳은 누군가의 '삶의 일부분' 그 자체였습니다.\n\n건축이 공간을 새로 창조하는 일이라지만, 100년의 기억을 아무런 흔적 없이 지워버리는 설계자가 될 수는 없었습니다. 저는 이 시장의 공간과 기억을 현대적인 개발과 공존시킬 방법을 치열하게 고민했습니다.\n\n그렇게 탄생한 스케치가 바로 **'상부 덮개 공원과 하부 시장'**의 입체적 결합이었습니다. 거대한 구조물의 하부에는 시장 상인들의 삶의 터전을 온전히 보존하고, 상부에는 브릿지가 교차하는 거대한 공원을 덮어 올리는 계획. 최소한 그 정도의 공간적 배려는 있어야 시장의 100년 명맥이 이어질 수 있을 것 같았습니다.\n\n**스케치 너머에 도사린 무거운 질문들**\n\n하지만 도면에서 펜을 떼는 순간, 진짜 현실의 벽이 숨통을 조여왔습니다.\n\n'상부를 공원으로 덮는 이 막대한 공사비를 조합이 기꺼이 감당할 것인가?'\n'3년이 넘는 공사 기간 동안, 하루 벌어 하루 먹고사는 상인들은 어디로 가서 생존해야 하는가?'\n'현행법상 이 전례 없는 복합 구조물을 지자체가 인허가해 줄 것인가?'\n\n종이 위에서 100년의 기억을 보존하는 선을 긋는 것은 건축가의 아름다운 낭만이었지만, 그것을 실체로 만들어내기 위해서는 낭만을 넘어선 처절한 '조율'이 필요했습니다. 자본의 이윤을 설득하고, 행정의 경직성을 깨뜨리며, 무엇보다 상인들의 3년 치 생존 대책을 함께 껴안지 않는 한 저의 스케치는 그저 위선적인 그림 쪼가리에 불과했습니다.\n\n건축은 선으로 낭만을 그리는 일이 아닙니다$2 100년의 기억을 덮으려면, 그 기억의 무게만큼이나 무거운 현실의 고통을 짊어질 각오가 되어 있어야 합니다. 대전의 그 낡은 시장 골목에서, 저는 도면 위에 그은 선 한 줄이 얼마나 무서운 책임감을 요구하는지 뼈저리게 배웠습니다.",
        ...
        },
        {
            "type": "image_top",
            "title": "오뚝이",
            "text": "흔들릴지언정 넘어지지 않는, <br><br>그래서 <br>재미 삼아 툭툭 건드려도 상관없는 <br><br>난 <br>중심 잡힌 오뚝이인 줄 알았습니다. <br><br>근데 이젠, 작은 입김에도 휘청이며 중심 잡기 위해 <br>몹시도 흔들거리는, 아파서 흔들거리는 제가 되었습니다.<br><br><img src=\"static/images/36.jpg\" alt=\"현장 스케치\" style=\"width:100%; border-radius:12px; margin: 30px 0;\"><br><br>세월의 흐름속에 <br>내안에 가라앉은 침잠된 무게가 중심추 되어, <br><br>이젠 <br>웬만한 바람이 불어도 <br>비록 흔들거릴지언정 넘어지지는 않는 <br>난 오뚝이 인데, <br>그래 그렇지. <br><br>내 속에 침잠된 그 묵직함이 <br>오늘의 저를 지켜줍니다.<br><br><div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\"><strong>오늘도 사랑한다로 시작합니다</strong><br><br>오늘 하루, 난 또 다른 모습으로 뭍의 삶을 살아갑니다. 태초의 쉼터인 물로 돌아가기 전까지 모두가 그렇게 살아갑니다. 특별할 것 없습니다. 매 맞는 말의 모습에서 메시아를 보았던 니체처럼, 언젠가 나도 이 고달픈 쟁이 삶의 끝에서 희열의 본질을 마주하겠지. 오늘도 저는 '사랑한다'는 말로 하루를 시작합니다. 그리고 하루의 마지막엔, '나는 사랑했다'로 끝을 맺고 싶습니다.</div>",
        ...
        },
        {
            ...
            "text": "토요일 이른 아침, 텅 빈 현장으로 출근하는 차 안에서 저는 문득 거대한 질문과 마주했습니다.\n\n그동안 우리는 새로운 디지털 설계 도구를 통해 데이터를 장악하고, 수백억짜리 타당성 검토를 순식간에 끝내며, 회사를 파멸시킬 법적 리스크를 단단하게 통제하는 시스템을 구축했습니다. '관리'와 '효율성'의 측면에서 AI는 의심할 여지 없는 최고의 무기였습니다.\n\n하지만, **디자인은 어떤가?**\n\n우리가 아파트 건물 덩어리(주동) 하나를 대지 위에 얹을 때, 단순히 법정 건폐율이나 일조 사선(햇빛을 가리지 않게 건물을 깎는 규제)을 통과했다고 끝나는 것이 아닙니다$2 지형을 어떻게 해석할 것인가? 사람들이 단지에 진입할 때 공간이 주는 위압감을 어떻게 줄이고 편안함을 느끼게 할 것인가? 이 시각적이고 인지적인 해석, 즉 심리적이고 공간적인 추상성의 영역은 결코 기계의 연산만으로는 실현될 수 없습니다. 그것은 철저히 인간의 영혼과 직관이 닿아야 하는 지점입니다.\n\n그렇다면 디자인에서 AI의 역할은 무엇인가?",
            "image": "static/images/sketches/112.jpg",
            "part": "4부: 증언과 성찰",
            "partTitle": "시스템 너머의 본질",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거"
        },
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "에너지의 소진으로",
            "text": "사람의 죽음을 이해하는 사람도 있고, <br>평생 먹는 음식의 량이나 숨쉬기의 횟수가 정해져있어 그 한계가 왔을 때 <br>죽음에 이른다는 사람이 있다 <br><br>제가 생각하기엔 <br>자기 인식을 한 이후 <br>본인의 과거 사건과 시간 또는 그 어떠한것에 메여, <br><br>현실의 시간에 살지못할 때 <br>오늘을 살아갈 힘을 잃게되었을 때<br><br>그때가 죽음이지 않을까?\n\n<div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\">저는 오늘 하루를 온전한 '현재'로 살아가고 있는 것일까, 아니면 과거의 회상 속에 머물러 살아가고 있는 것일까. 어쩌면 미래의 죽음을 앞둔 제가 잠시 떠올린 찰나의 기억 속 한 장면은 아닐까.<br><br>멍하니 내 손가락을 꾹꾹 눌러봅니다. 살결의 통각이 전해집니다. 그래, 환영이 아닌 현실의 삶이구나. 단순한 슬픔을 넘어, 삶이라는 것 자체가 유독 애달프게 다가오는 요즘입니다. 하지만 이 애달픔은 결코 허무함이 아닙니다$2 끝이 있음을 감각하는 그 순간, 오늘 무심코 마신 커피 한 잔, 스쳐 지나가는 바람, 그리고 내 곁을 지키는 사람들의 온기가 비로소 선명하게 다가옵니다. 죽음을 곁눈질하며 걷는 일은, 역설적이게도 '오늘'이라는 현실을 가장 눈부시게 살아내기 위한 유일한 방법일지도 모릅니다.</div>",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "요즘 잠을 잘 수가 없다",
            "text": "요즘 난 잠을 잘 수가 없습니다.<br><br>눈을 감으면,<br>저의 모든 감각 기관이 더욱 예민해집니다.<br>어느 날은 자고 있는 상태에서도<br>내 옆에 기어가는 벌레를 인지하고 잡은 적도 있습니다.<br><br>심지어<br><br>난 눈을 뜨고 잡니다.<br>자고 있는 나에게 말을 붙이면 대답을 합니다.<br><br>군에서는<br>선임들이 내 머리카락만 건드려도 관등성명을 댄다고 모두들 신기해했지만,<br>사실 난 자면서도 그들의 모든 일거수일투족을 인지하고 있었습니다.<br><br>저의 이 능력은 사실 지네에게 물렸을 때 생긴 능력입니다.<br><br>거미에 물렸다면 스파이더맨이 될 수도 있었는데 아깝습니다.<br>아무튼,<br>난 지네맨이 되었습니다.<br><br>지네가 가진 예민한 촉각을 제가 가지게 된 것입니다.<br>몹시 예민합니다.<br>이런 능력을 가진 후 몇 가지 단점도 생겼습니다.<br><br>첫째는, 밤에 예민하다 보니 낮에 몹시 둔하다는 것입니다.<br>말도 행동도 느리고, 쉽게 다른 사람의 말을 알아듣지도 못하게 되었습니다.<br>둘째, 너무 많은 정보가 내게 쏟아져 들어옵니다. 주변의 모든 정보가.<br>그래서, 난 더 둔해집니다. 화를 낼 일도 한참 나중에 되어서야 '아! 그때 화를 냈어야 했는데' 하고 후회하곤 합니다.<br><br>결국 난 몹시 예민하지만, 몹시도 둔한 사람이 되었습니다.<br><br><div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\">어떨 땐 너무 둔하고, 또 어떨 땐 너무 예민하게 신경이 곤두서서 나도 모르게 손발이 떨릴 때가 있습니다. 긴장해서 말마저 더듬거릴 때면, 저는 속으로 중얼거립니다. '그래, 나는 지네맨이었지. 아니면 지구에 불시착한 외계인이거나.' 그렇게 나 스스로를 세뇌하며 버텨냅니다. 참 하루하루가 고단하고 쉽지 않습니다. 하지만 출근길 만원 지하철, 무표정한 얼굴로 흔들리는 수많은 사람들을 봅니다. 어쩌면 저들도 겉으로는 둔탁해 보이지만, 속으로는 상처받지 않기 위해 온갖 더듬이를 세운 채 하루를 간신히 버텨내는 또 다른 지네맨들이 아닐까. 둔감함이라는 갑옷을 입고 살아가는 세상의 모든 예민한 영혼들에게, 속으로 남몰래 연대의 위로를 건네봅니다.</div>",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "내 자신은",
            "text": "제 자신은<br>제가 스스로를<br>더럽히지 않는 한,<br><br>절대,<br>타인에 의해 더럽혀지지는 않습니다.<br><br>화가 날 때맙니다.<br>난 절대,<br>타인에 의해 더럽혀지지 않습니다.<br><br>내 스스로 저를 더럽히지 않는 한<br><br>그렇게 난 매번 중얼거립니다.<br>근데, 더럽혀진 것은 씻으면 되는데,<br>그게, 상처가 되어 남습니다.<br><br>그게, 나로 하여금 오늘을 집중하지 못하게 하고,<br>오늘의 저의 모습이기도 합니다.<br><br><div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\">그래, 귀로든 입으로든 들어오는 타인의 불순물에 제가 진짜로 더럽혀지지는 않습니다. 그냥 '그렇구나' 하고 내 속에 고여 맴돌게만 두지 않으면 그만입니다.<br><br>하지만 참 이상하게도, 어떤 상처는 씻겨 내려가지 않고 아주 오래 남습니다. 예전 대학교 졸업할 때, 한 선배가 선물한 책에 적어준 글귀가 떠오릅니다. \"처마에 떨어진 물 한 방울같이 작은 오해가, 우리 사이를 천길 낭떠러지처럼 갈라놓았다\"는 말. 지금의 나 역시 그 '물 한 방울' 같은 사소한 앙금으로 누군가와 멀어진 채 후회 속을 걷고 있는지 모릅니다. 참 별거 아닌 일인데도 지독하게도 오래 품고 삽니다.<br><br>그런데 어떨 때는, 이 알량하고 뾰족한 상처마저 둥글게 깎아버리고 모든 것에 무던해지면 '나'라는 존재 자체가 뭉개질 것만 같아 모질게 부여잡고 있을 때가 있습니다. 누구나 가슴속에 절대 아물게 두고 싶지 않은 상처 하나쯤은 독하게 품고 살지 않는가. 그것이 때로는, 부서질 것 같은 자아를 지탱하는 가장 인간적인 고집이 되기도 하니까.</div>",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
        ...
        },
        {
            ...
            "image": "static/images/sketches/105-1.jpg",
            "part": "4부: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거"
        },
        ...
        },
        {
            ...
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
            "image": "static/images/sketches/114.jpg",
            "type": "image_top"
        },
        {
            "type": "image_top",
            ...
            "text": "**책임지지 않는 도면과 수억 원의 렌더링**\n\n최근 서울의 정비사업에서 설계자를 선정하는 방식을 지켜보고 있으면, 오랜 시간 도면을 그려온 쟁이로서 입맛이 씁쓸해질 때가 많습니다.\n\n통상적으로 설계자 선정은 '적격 심사'와 '설계 공모' 방식으로 나뉩니다. 그런데 요즘 많은 조합들이 적격 심사 방식을 취하면서도 은근슬쩍 '설계 제안서'를 함께 요구하는 기형적인 형태를 띠고 있습니다. 제도상으로는 제안서가 심사 배점에 전혀 영향을 미치지 않는다고 못 박혀 있지만, 막상 총회에 모인 조합원들의 마음을 움직이는 것은 결국 눈앞에 펼쳐진 화려한 제안섭니다. 사람의 인지상정(人之常情)이 그러합니다.\n\n설계 공모 방식이라면 제출된 도면의 법적 타당성과 작품성을 꼼꼼히 따져보는 전문가의 평가 절차가 수반됩니다. 하지만 적격 심사에 슬쩍 끼워 넣은 제안 방식에는 그 계획안을 검증할 전문가도 없고, 심지어 설계자가 뜬구름 잡는 계획안을 내놓아도 아무런 법적 책임을 지지 않습니다. 그저 수주를 위해 그릴 수 있는 가장 화려하고 비현실적인 그림을 그려낼 뿐입니다.",
            "part": "4부: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거"
        },
        ...
        },
        {
            ...
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
            "image": "static/images/sketches/121.jpg",
            "type": "image_top"
        },
        {
            "part": "4부: 증언과 성찰",
            ...
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
            "image": "static/images/sketches/122-1.jpg",
            "type": "image_top"
        },
        {
            "part": "4부: 증언과 성찰",
        ...
        },
        {
            ...
            "partCategory": "2부. 현장의 목소리, 공유결합의 증거",
            "image": "static/images/sketches/15-1.jpg",
            "type": "image_top"
        },
        {
            "type": "text",
        ...
        },
        {
            ...
            "text": "처음 AI 시스템 구축을 결심했을 때, 저는 흔히 말하는 '코딩의 코 자도 모르는' 전형적인 비개발자였습니다. 파이썬(Python)의 기본 문법조차 몰랐고, 터미널 창을 여는 것조차 낯설어했습니다. 아마추어의 섣부른 도전이라는 주변의 만류도 많았습니다.\n\n![현장 스케치](static/images/32.jpg)\n\n하지만 저는 개발 언어를 모르는 대신, 제가 도달하고자 하는 **'목표'**가 무엇인지 분명하게 알고 있었습니다.\n\n기계에게 다짜고짜 코드를 짜내라고 요구하는 대신, 제가 구상한 데이터의 흐름과 시스템의 위계를 논리적인 '건축 도면(흐름도)'처럼 펼쳐 보이기 시작했습니다. 새로운 디지털 설계 도구(통합 대시보드)와 J-Journal(개별 저널)이 어떻게 서로 데이터를 주고받아야 하는지, 사용자가 어떤 순서로 버튼을 누르고 화면을 봐야 하는지, 그 모든 프로세스가 이미 완벽한 건축 설계도처럼 머릿속에 구조화되어 있었습니다. 코딩은 단지 그 설계도를 번역하는 망치와 톱일 뿐이었습니다.",
        ...
        },
        {
            "type": "text_only",
            "title": "철학의 기술화",
            "text": "기술이 우리를 지배하면 '쓸모없는 건축가'가 되지만, 기술이 우리를 돕게 하면 '더 나은 건축가'가 됩니다.<br><br>2부에서 우리는 수많은 갈등과 혼란을 날것 그대로 목격했습니다. 3부는 바로 그 혼란의 현장에서, **새로운 디지털 설계 도구**라는 시스템과 그 두뇌인 AI **'아키 시냅스'**가 어떻게 구체적으로 개입하여 인간의 판단을 돕는지에 대한 실제적 기록입니다.",
        ...
        },
        {
            ...
            "title": "제1장. 신뢰를 기록하다",
            "text": "새로운 디지털 설계 도구의 존재 이유는 '업무의 자동화'가 아니라 '투명성과 책임의 기록'에 있습니다. 추상적인 철학은 현장의 거친 목소리 앞에서 힘을 잃습니다. 우리는 기술이 어떻게 그 불신의 장벽을 허무는지 용산의 한 현장에서 목격했습니다.\n\n<br><strong style=\"color: #1d1d1f;\">현장 스케치: 숫자가 눈물을 닦아줄 수 있을까?</strong><br><span style=\"font-size: 13px; color: #777;\">(*이 에피소드는 과거 정비사업 현장들의 실제 갈등 사례를 바탕으로, 미래의 디지털 도구가 적용되었을 때의 긍정적 변화를 상상하여 재구성한 시나리오입니다.)</span><br>\n\"왜 저 집은 3억이고 내 집은 2억인가!\"\n조합 사무실에 뛰어들어와 분통을 터뜨리는 70대 조합원 앞에서는 어떤 화려한 언변도 무력해집니다. 과거였다면 목소리 큰 사람이 이기거나, 끝없는 소송으로 이어졌을 것입니다. 우리는 새로운 디지털 설계 도구의 '종전자산 시뮬레이터'를 켰습니다. 모니터 위로 주변 공시지가 변동률, 건축 연한, 도로 접도율에 따른 기여도가 3D 그래프로 선명하게 펼쳐졌습니다. 나와 이웃의 자산이 어떤 객관적 기준에 의해 다르게 평가되었는지 투명하게 시각화된 순간이었습니다. 붉은색(위험)과 푸른색(안전)으로 나뉜 지표 위로, 할머니의 낡은 단층집이 안고 있던 도로 미접도 리스크와 옆집이 누리던 2차선 도로의 가치 차이가 입체적으로 회전하며 나타났습니다. 핏대가 서 있던 할머니의 주름진 눈매가 모니터를 향해 천천히 다가왔습니다. 숫자가 거짓말을 하지 않는다는 것을, 그리고 우리가 그 숫자를 무기로 그녀를 공격하는 것이 아니라 오히려 투명하게 보호하려 한다는 것을 직관적으로 깨달은 것입니다. 꽉 쥐고 있던 그녀의 거친 두 손에 서서히 힘이 풀렸습니다. 기계가 산출한 차가운 숫자가, 수십 년 묵은 불신의 안개를 걷어내고 따뜻한 이해를 피워낸 기적 같은 순간이었습니다.\n\n\n\n<div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\">새로운 디지털 설계 도구는 0.1초 만에 반경 5km 내의 100만 건의 부동산 공시지가, 건축 연한, 접도율 데이터를 분석하여 오차 없는 '종전자산 3D 그래프'를 모니터에 렌더링한다.<br><br>하지만 그 차가운 모니터를 돌려 분통을 터뜨리는 할머니와 눈을 맞추고, 그 숫자가 결코 당신의 삶을 깎아내리는 것이 아님을, 이것이 의미하는 '정당함'이 무엇인지를 차분한 목소리로 설득하는 일. 마침내 억울함에 꽉 쥐어졌던 그 두 손을 스르르 풀게 만드는 일. 그것은 수백만 번의 연산을 거친 기계가 아니라, 오직 투박한 온기를 가진 인간만이 할 수 있는 일이다.</div>",
            "partCategory": "3부. 공유결합의 완성, J-Hub",
        ...
        },
        {
            ...
            "text": "기술은 우리가 신는 신발을 훨씬 편하게 개선해 주었지만, 결국 어느 방향으로 걸어갈지는 여전히 사람이 결정해야 합니다.\n\n새로운 디지털 설계 도구가 의 완벽한 데이터를 제공하더라도, 건축을 최종적으로 완성하는 것은 인간의 불완전한 1%입니다. 오랜 시간의 경험에서 얻은 진짜 깨달음은, 기술이 우리를 흠결 없는 완벽한 존재로 만들어 주는 것이 아니라는 점이었습니다. 오히려 기술은 우리의 불완전함을 겸허히 받아들이게 하고, 타인에 대한 공감과 책임감이라는 기계가 할 수 없는 영역에 집중하게 함으로써 우리를 더욱 '인간다운 건축가'로 만들어 줍니다.\n\n내일 아침 현장에 가면, 저는 여전히 투박한 손으로 도면 위에 선을 긋고, 의심 가득한 조합원의 손을 잡고 설득할 것입니다. 새로운 디지털 설계 도구는 내 손가락을 대신 움직여 도면을 그려주지 않습니다. 다만, 나의 복잡한 연산을 덜어주어, 그들의 손을 맞잡고 설득할 귀중한 '인간의 시간'을 벌어줄 뿐입니다.\n\n처음 현장의 진흙탕을 누비며 밑창이 다 떨어져 나갔던 그 '찢어진 운동화'의 기억이 떠오릅니다. 그때는 그저 살아남고 버티기 위해 신발 끈을 꽉 동여맸다면, 이제는 가장 날카로운 무기인 새로운 디지털 설계 도구를 등에 업고 다시 한번 먼지 묻은 신발 끈을 고쳐 맵니다.\n\n기술이 내 운동화의 닳은 밑창을 두껍게 만들어주진 못하겠지만, 적어도 내가 딛는 걸음마다 흔들리지 않는 이정표가 되어줄 것입니다. 찢어진 운동화에서 시작된 이 불완전한 여정의 끝이, 온전히 사람의 냄새로 가득 찬 공간이 되기를 기원하며 현장으로 문을 나섭니다.",
            "partCategory": "에필로그",
            "image": "static/images/sketches/116.jpg"
        }
    ]
