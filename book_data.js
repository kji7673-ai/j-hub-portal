var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "title": "관계의 재설정",
            "partCategory": "제1막: 공유결합 디자인 방법론",
            "text": "가장 사적인 관계에서 발견한 '공유결합'의 온기는, 이제 저의 작업실을 넘어 도면을 들고 만나는 치열한 현장으로 확장되어야 했습니다.<br><br>그렇다면 이제 저의 도면이 닿아야 할 그 '상대'들은 과연 어떤 분들일까요?<br><br>여기서 우리가 절대 오해하면 안 되는 것이 있습니다. 설계자가 현장에서 만나는 시공사, 관공서, 조합의 수많은 사람들을 그들이 속한 '이익 집단'이라는 꼬리표 하나로 묶어 쉽게 치부해 버려서는 안 된다는 점입니다.<br><br>소통은 서로를 알아가는 것에서 시작됩니다. 제가 부족한 것을 상대가 채워주고, 상대가 모르는 것을 제가 짚어주며, 서로를 단순한 이용 대상이 아닌 '귀중한 존재'로 대할 때 비로소 진정한 공유결합이 일어납니다.<br><br>건축가는 그저 흔들리지 않는 중심을 잡아주는 사람입니다. 그리고 그분들의 눈에 보이지 않는 이상과 목표를 '보이도록' 만들어 주는 사람입니다.<br><br>한때, 현장에서 만난 분들이 제게 \"대표님, 그림 좀 잘 그려주세요\"라고 부탁할 때면, 속으로 '제가 화가도 아니고 웬 그림을 그려달라고 하나'라며 뾰족하게 날을 세우던 시절이 있었습니다.<br><br>하지만 지금은 다릅니다. 그 투박한 말속에 담긴 진심을 압니다. <strong>\"우리의 보이지 않는 실체와 바람을 제발 구체화해 주세요\"</strong>라는 간절한 마음을, 그저 그분들의 가장 편안하고 일상적인 언어로 표현했을 뿐이라는 것을 말입니다.<br><br>언젠가 한 회의 석상에서 누군가 이런 말을 한 적이 있습니다.<br>\"생각하시는 바를 그냥 편하게 펼쳐 놓으십시오. 제가 잘 담아내겠습니다.\"<br><br>이 얼마나 멋진 태도입니까? 상대의 언어가 거칠든 곱든, 뾰족하든 투박하든, 건축사인 제가 그것을 둥글게 잘 담아내기만 하면 되는 것이었습니다.<br><br>그들의 투박한 언어를 둥글게 이해하고, 거친 생각들조차 온전히 내 그릇에 담아 그들을 귀중한 존재로 껴안는 것. 그것이 바로 상대를 이해하는 진짜 방식이며, 현장을 향한 공유결합의 두 번째 발걸음입니다.",
        ...
        },
        {
            "type": "image_top",
            "title": "간격: 그 사이 공간의 힘",
            "text": "디자인은 단순히 보기 좋은 것을 만드는 작업이 아닙니다.<br>관계를 설정하고, 관계 속에서의 에너지를 조율하는 일입니다.<br><br>\"떨어져 생긴 사이 공간은 그냥 빈 공간이 아닙니다.<br>떨어진 것을 연결하고, 개체의 속성을 유지하며, <br>전체를 하나로 보이게 합니다.\"<br><br>인간의 뇌는 파편화된 정보를 통합하려는 습성이 있습니다. 너무 붙어있는 것은 나누어 보려 하고, 떨어져 있는 것은 연결해 보려 합니다. 바로 이 지점에서 '사이 공간(Void)'이 만드는 놀라운 에너지가 발생합니다.<br><br>미켈란젤로의 '천지창조'를 떠올려 보십시오. 아담과 신의 손끝이 닿을 듯 말 듯 한 그 찰저의 '사이 공간'에 창조의 가장 강력한 에너지가 응축되어 있습니다. 거대한 매스(Mass)에는 적절한 분절이 필요하고, 빈 공간만큼 요소들을 강력하게 연결해 주는 접착제는 또 없습니다.<br><br><div style=\"background-color: #f5f5f7; padding: 24px; border-radius: 12px; margin-top: 32px;\"><p style=\"margin: 0; color: #1d1d1f; line-height: 1.7; font-size: 0.95em;\">건축이 아닌 사람 사이의 간격이라는 것도 참 어려운 이야기입니다.<br><br>가깝다고 믿었던 이가 어느 순간 아득히 멀어져 있을 때도 있습니다. 조심스레 상대와의 적당한 간격을 유지하며, 오늘 내 앞에 있는 사람에게 집중하고 최선을 다해야 합니다. 언제나 내 곁에 있는 사람은 나와 연결된 '나라는 존재의 이유'가 되기 때문입니다.<br><br>하지만, 다들 아시겠지만 그게 참 쉬운 일이 아닙니다.</div>",
        ...
        },
        {
            ...
            "text": "나라는 개체의 흔들림 없는 중심은, 역설적이게도 수많은 부딪침과 깨짐을 통해서만 만들어집니다.<br><br>설계하는 일에서 좋은 점은 바로 이 '생각의 부딪침'이 많다는 것입니다.<br>부딪침,<br>깨짐,<br>이를 통한 생각의 확장.<br><br>언제나 조심해야 할 것은<br>생각의 부딪침을 자연스럽게 받아들여야 한다는 것입니다.<br>어떤 때는 통과되기도, 또는 털어버릴 때도 있겠지만,<br>적어도 고정된 생각을 무기로 만들어 이리저리 흔들어대는 행동은 하지 말아야 합니다.<br><br>오늘도 부딪침, 깨짐, 그리고 확장과 거리두기를 기대합니다.<br><br>이 부딪침과 깨짐의 기록은 결코 거창한 설계 도면에만 남아있는 것이 아닙니다. 때로는 퇴근길 가파른 언덕을 오르며, 때로는 잠들기 전 끄적인 짧은 일기 속에 제 고민들이 더 날것으로 담겨 있습니다.<br><br>앞으로 이어질 개인적인 단상과 짧은 시들은, 무거운 현장을 버텨내고 '나'라는 개체의 중심을 지키기 위해 홀로 마음을 다듬었던 흔적들입니다.",
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "요즘 잠을 잘 수가 없다",
            "text": "<div style=\"text-align: center; max-width: 500px; margin: 0 auto;\">\n<p style=\"text-align: left; line-height: 1.85; font-size: 1.1em; color: #333; margin-top: 40px; margin-bottom: 60px; display: inline-block;\">\n요즘 저는 잠을 잘 수가 없습니다.<br><br>눈을 감으면,<br>저의 모든 감각 기관이 더욱 예민해집니다.<br>어느 날은 자고 있는 상태에서도<br>제 옆에 기어가는 벌레를 인지하고 잡은 적도 있습니다.<br><br>심지어<br><br>저는 눈을 뜨고 잡니다.<br>자고 있는 나에게 말을 붙이면 대답을 합니다.<br><br>군에서는 선임들이 제 머리카락만 건드려도<br>관등성명을 댄다고 모두들 신기해했지만,<br>사실 저는 자면서도 그들의 모든 일거수일투족을<br>인지하고 있었습니다.<br><br>저의 이 능력은 사실 지네에게 물렸을 때 생긴 능력입니다.<br><br>거미에 물렸다면 스파이더맨이 될 수도 있었는데 아깝습니다.<br>아무튼, 저는 지네맨이 되었습니다.<br><br>지네가 가진 예민한 촉각을 제가 가지게 된 것입니다.<br>몹시 예민합니다.<br>이런 능력을 가진 후 몇 가지 단점도 생겼습니다.<br><br>첫째는, 밤에 예민하다 보니 낮에 몹시 둔하다는 것입니다.<br>말도 행동도 느리고, 쉽게 다른 사람의 말을 알아듣지도 못하게 되었습니다.<br><br>둘째, 너무 많은 정보가 내게 쏟아져 들어옵니다. 주변의 모든 정보가.<br>그래서, 저는 더 둔해집니다.<br>화를 낼 일도 한참 나중에 되어서야<br>'아! 그때 화를 냈어야 했는데' 하고 후회하곤 합니다.<br><br>결국 저는 몹시 예민하지만, 몹시도 둔한 사람이 되었습니다.\n</p>\n</div>\n\n<blockquote style=\"background: rgba(0, 0, 0, 0.04); border-radius: 8px; padding: 20px 24px; font-size: 0.9em; color: #555; line-height: 1.6; border: none; margin-top: 40px;\">\n아직도 전 어떨 땐 너무 둔하고, 또 어떨 땐 너무 예민하게 신경이 곤두서서 저도 모르게 손발이 떨릴 때가 있습니다. 긴장해서 말마저 더듬거릴 때면, 저는 속으로 중얼거립니다.<br><br>\n'그래, 저는 지네맨이었지. 아니면 지구에 불시착한 외계인이거나.'<br><br>\n그렇게 나 스스로를 세뇌하며 버텨냅니다. 참 하루하루가 고단하고 쉽지 않습니다. 어쩌면 나만 이 이상한 능력이 있지는 않을 것 같습니다.<br><br>\n다른 사람들도 겉으로는 무표정해 보이지만, 속으로는 상처받지 않기 위해 온갖 더듬이를 세운 채 하루를 간신히 버텨내는 또 다른 지네맨들이 아닐까 싶습니다.<br><br>\n둔감함이라는 갑옷을 입고 살아가는 세상의 모든 이상 능력 소유자들에게 연대의 위로를 건네봅니다.\n</blockquote>",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
