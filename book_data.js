var bookData = {
    "pages": [
        ...
        },
        {
            "type": "bridge",
            "title": "기록의 무게",
            "text": "다음에 이어질 제가 생각하는 디자인 개념들은 오랜 기간 사람들과 공유결합하며 남겨진 것들입니다.<br><br>이 글을 볼 후배들이나 저를 아는 분들이 '아, 이 친구가 이런 생각으로 설계를 하는 사람이구나' 하고 조금이라도 알아주시면 좋겠습니다.",
            "partCategory": "1부. 설계의 본질 – 공유결합",
        ...
        },
        {
            ...
            "text": "후배들에게 늘 당부하는 말이 있습니다. 설계란 그저 건물을 그리는 것이 아니라, '생각을 잘하고 그것을 제대로 표현할 줄 아는 것'이라고요. 특히 그 표현에는 말과 글과 그림이 있으며, 이 모든 표현의 궁극적인 목적은 결국 타인과의 교감, 즉 '소통'에 있습니다.<br><br>저 역시 늘 그런 사람이 되려 발버둥 쳐 왔습니다. 이어지는 글들은 완벽한 도면(그림) 이전에, 현장의 사람들과 소통하고 교감하기 위해 남겼던 저의 치열한 '말'과 '글'들의 기록입니다."
        },
        {
            "type": "cover",
            "title": "내가 생각하는 디자인이란?",
