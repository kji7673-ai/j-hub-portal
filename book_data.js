    ...
    "pages": [
        {
            ...
            "text": "<p style=\"text-align: left; font-size:1.1em; color:var(--ink, #333); margin-top:24px; font-weight:600; text-shadow: 0 0 5px rgba(255,255,255,0.8);\">건축과 사람, 그리고 삶을 잇는 단단한 흔적들</p>",
            "type": "cover"
        },
        {
            "partCategory": "저자 소개",
        ...
        },
        {
            ...
            "subtitle": "",
            "image": null,
            "text": "애초에 어떤 거창한 의도를 가지고 쓴 글들이 아닙니다.<br>\n그저 가슴에 담아두기가 너무 힘겨워, 마음속에 맺힌 것들을 하나씩 덜어내는 심정으로 적어 내려간 글들입니다.<br><br>\n비록 세상에 내놓기 몹시 부끄럽지만, 제 머릿속의 거칠고 부끄러운 감정들을 용기 내어 갤러리의 조각상들처럼 꺼내어 전시해 봅니다.<br><br>이 책은 건축에 관한 이야기이자, 동시에 당신의 삶과 관계에 관한 이야기입니다. 딱딱한 콘크리트와 차가운 법규 사이에서 사람들이 어떻게 부대끼며 살아가는지, 그리고 그 안에서 우리는 타인과 어떤 선을 긋고 살아야 하는지... 그 해답을 제 삶의 궤적이 담긴 도면 위에서 함께 찾아보려 합니다.",
            "part": "제1막: 프롭테크와 정비사업의 미래",
            "partCategory": "",
            "caption": null,
            "isContinuation": true,
