const bookData = {
    "pages": [
        {
            "title": "도면 위의 공유결합",
            "image": "static/images/gallery_cover.jpg",
        ...
        },
        {
            ...
            "partTitle": "[Theme 3] 설계의 본질에 대한 고민",
            "title": "구겨진 도면",
            "text": "<div style=\"text-align: center; max-width: 500px; margin: 0 auto;\"><br><p><br>손안에서<br>이리저리 움직여 봅니다.<br><br>바스락거리며<br>제 손의 움직임 따라 저를 간지럽히며, 내는 소리,<br>제 손안에 거미줄 치듯 작은 상처로 제게 말을 걸어옵니다.<br><br>여리디여린 종이 조각은 원래 그랬던 것처럼,<br>이리저리 희롱당한 것을 오히려 자랑하듯<br><br>수없이 반짝이는 조각을 자랑하듯.<br>그렇게 그렇게 구겨져<br><br>결국엔 버려지게 됩니다.<br></p><br></div><br><br><blockquote class=\"custom-quote\"><br>사실 이 글은, 어느 날 손안에 남은 얇은 사탕 포장지를 이리저리 쥐었다 폈다 하며 썼던 글입니다. 구겨지고 상처 입으면서도 반짝이는 그 종이 쪼가리가, 어쩌면 저란 사람과 참 닮아있구나 싶어 씁쓸함을 삼켰던 기억이 납니다.<br></blockquote>",
            "image": null,
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
            "type": "poem",
            "caption": null,
