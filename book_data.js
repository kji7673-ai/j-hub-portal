var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "외로움",
            "text": "외로우신가요?<br>외로움을 채우기 위해<br>무언가로 채우지만<br>쉽지 않네요<br>채우기 위해 무언가를 집어넣지만<br>그로 인해 그 깊이만 더 깊어집니다<br>채우다 채웁니다<br>문득 제가 채운 자리의 바닥이 보이지 않는<br>깊은 어둠이 되어버렸을 때,<br>그 깊은 깊이속에 갇혀버렸음을<br>알게 됩니다<br>이제는 어쩌나 하고<br>바닥에 주저앉아 가만히 있다 보면<br>바닥은 올라가고<br>어느새 제가 다시 빠질 정도는 아니네하고<br>깨닫게 됩니다<br>외로울 땐<br>지나가길 기다려야 되나 봅니다<br>꼭 외로움이 아닌 슬픔과 화남도<br>지나가길 기다려야 되나 봅니다",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
            "image": null,
            "type": "image_top",
            "caption": null,
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "요즘 잠을 잘 수가 없다",
            "text": "<div style=\"text-align: center; max-width: 500px; margin: 0 auto;\">\n<p style=\"text-align: left; line-height: 1.85; font-size: 1.1em; color: #333; margin-top: 40px; margin-bottom: 60px; display: inline-block;\">\n요즘 저는 잠을 잘 수가 없습니다.<br><br>눈을 감으면,<br>저의 모든 감각 기관이 더욱 예민해집니다.<br>어느 날은 자고 있는 상태에서도<br>제 옆에 기어가는 벌레를 인지하고 잡은 적도 있습니다.<br><br>심지어<br><br>저는 눈을 뜨고 잡니다.<br>자고 있는 제게 말을 붙이면 대답을 합니다.<br><br>군에서는 선임들이 제 머리카락만 건드려도<br>관등성명을 댄다고 모두들 신기해했지만,<br>사실 저는 자면서도 그들의 모든 일거수일투족을<br>인지하고 있었습니다.<br><br>저의 이 능력은 사실 지네에게 물렸을 때 생긴 능력입니다.<br><br>거미에 물렸다면 스파이더맨이 될 수도 있었는데 아깝습니다.<br>아무튼, 저는 지네맨이 되었습니다.<br><br>지네가 가진 예민한 촉각을 제가 가지게 된 것입니다.<br>몹시 예민합니다.<br>이런 능력을 가진 후 몇 가지 단점도 생겼습니다.</div></p>",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
            "image": null,
            "type": "poem",
            "caption": null,
