const bookData = {
    "pages": [
        ...
        },
        {
            "type": "text_only",
            "title": "간격: 그 사이 공간의 힘",
            "text": "다시 한번 사이 공간, 여백, 또는 '거리 두기'에 대해서 이야기를 해볼까요?<br><br>\n앞서 말씀드린 것처럼, 인간의 뇌는 파편화된 정보를 통합하려는 습성이 있습니다. 너무 붙어있는 것은 나누어 보려 하고, 떨어져 있는 것은 연결해 보려 합니다. 바로 이 지점에서 적절한 간격은 강력한 에너지를 발생시킵니다.<br>\n미켈란젤로의 '천지창조'를 떠올려 보십시오. 아담과 신의 손끝이 닿을 듯 말 듯 한 그 찰나의 '사이 공간(간격)'에 창조의 에너지가 응축되어 있듯 말입니다.<br><br>\n그런데 이 적절한 거리 두기, 즉 여백이라는 것도 결국 커다란 테두리 안에서, 혹은 상대와의 관계가 존재할 때 비로소 성립됩니다.<br>\n크고 작음, 가까이 두기와 멀리 두기. 이 모든 것들이 적절한 에너지의 관계망 안에서 조화롭게 머물러야 합니다.<br><br>\n이 조화로움은 앞서 이야기한 우리 한국적 정형(正形)과 순응의 정신을 필요로 합니다. 무언가를 억지로 끼워 맞추는 것이 아니라, 주변을 감안하여 '당연히 있어야 할 곳에 마땅히 있게' 배치하는 것. 그것이 설계자의 진짜 능력입니다.<br><br>\n참으로 어려운 일입니다. 하지만 이것이 바로 제가 <strong>\"설계는 타고난 감각으로 하는 것이 아니라 성숙함, 즉 관계를 이해하는 마음의 크기에서 나온다\"</strong>고 감히 말씀드리는 이유입니다.<br><br>\n적절한 간격은 에너지를 발생시킵니다. 그리고 그 에너지는 사람을 향합니다.<br>\n제가 수많은 도면을 그리며 설계를 하면서도, 늘 새로운 사람을 만난다는 것에 변함없는 호기심과 기분 좋은 들뜸을 품게 되는 이유이기도 합니다.",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 4] 미완의 일상",
            "partCategory": "제1막: 공유결합 디자인 방법론",
