var bookData = {
    "pages": [
        ...
        {
            "type": "text",
            "title": "질문의 확장: \"그렇다면 사람들과의 관계 설정은?\"",
            "partCategory": "1부. 건축의 뼈대: 도면 위의 철학",
            "text": "이제 나의 도면이 닿아야 할 그 '상대'들은 과연 어떤 분들일까요?<br><br>여기서 우리가 절대 오해하면 안 되는 것이 있습니다. 설계자가 현장에서 만나는 시공사, 관공서, 조합의 수많은 사람들을 그들이 속한 '이익 집단'이라는 꼬리표 하나로 묶어 쉽게 치부해 버려서는 안 된다는 점입니다.<br><br>소통은 서로를 알아가는 것에서 시작됩니다. 내가 부족한 것을 상대가 채워주고, 상대가 모르는 것을 내가 짚어주며, 서로를 단순한 이용 대상이 아닌 '귀중한 존재'로 대할 때 비로소 진정한 공유결합이 일어납니다.<br><br>건축가는 그저 흔들리지 않는 중심을 잡아주는 사람입니다. 그리고 그분들의 눈에 보이지 않는 이상과 목표를 '보이도록' 만들어 주는 사람입니다.<br><br>한때, 현장에서 만난 분들이 제게 \"대표님, 그림 좀 잘 그려주세요\"라고 부탁할 때면, 속으로 '내가 화가도 아니고 웬 그림을 그려달라고 하나'라며 뾰족하게 날을 세우던 시절이 있었습니다.<br><br>하지만 지금은 다릅니다. 그 투박한 말속에 담긴 진심을 압니다. <strong>\"우리의 보이지 않는 실체와 바람을 제발 구체화해 주세요\"</strong>라는 간절한 마음을, 그저 그분들의 가장 편안하고 일상적인 언어로 표현했을 뿐이라는 것을 말입니다.<br><br>언젠가 한 회의 석상에서 누군가 이런 말을 한 적이 있습니다.<br>\"생각하시는 바를 그냥 편하게 펼쳐 놓으십시오. 제가 잘 담아내겠습니다.\"<br><br>이 얼마나 멋진 태도입니까? 상대의 언어가 거칠든 곱든, 뾰족하든 투박하든, 조율자인 제가 그것을 둥글게 잘 담아내기만 하면 되는 것이었습니다.<br><br>그들의 투박한 언어를 둥글게 이해하고, 거친 생각들조차 온전히 내 그릇에 담아 그들을 귀중한 존재로 껴안는 것. 그것이 바로 상대를 이해하는 진짜 방식이며, 현장을 향한 공유결합의 두 번째 발걸음입니다.",
