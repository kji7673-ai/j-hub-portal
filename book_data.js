var bookData = {
    "pages": [
        ...
        },
        {
            "type": "chapter_content",
            "title": "판단하는 건축가가 되다",
            "text": "현장의 복잡한 얽힘 속에서 미래의 기계는 끝없이 정교한 선택지를 제안할 것입니다. 재개발, 리모델링, 가로주택정비 등 수많은 의사결정 트리가 뻗어 나갑니다.<br><br>그러나 기계의 제안을 받아들여 최종 결단을 내리는 것은 철저히 건축가의 존엄으로 남아야 합니다. 우리가 실험한 시스템의 진정한 완성은 가장 똑똑한 AI를 만드는 데 있지 않았습니다. 가장 지혜롭게 판단할 수 있는 '인간 건축가'를 육성하는 훈련장이 되는 데 있었습니다.<br><br>이 부록에서 제시한 시스템의 개념과 뼈대들은 아직 거칠고 투박할지 모릅니다. 하지만 자본의 논리에 휘둘리지 않고, 도면 너머의 '사람'을 끝까지 지켜내고자 하는 이 작은 실험과 제안들이, 언젠가 우리 후배들이 살아갈 건축 현장의 당연한 미래가 되기를 간절히 소망합니다.",
