var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "partCategory": "[부록] 시스템의 기록, J-Hub",
            "image": "static/images/sketches/40.jpg",
            "text": "차가운 자본의 논리와 거친 현장에서, 인간의 온기와 건축의 본질을 잃지 않기 위해 우리가 고안해 낸 단단한 지지대(시스템)에 관한 기록입니다."
        },
        {
            "type": "text_only",
            "title": "철학의 기술화",
            "text": "기술이 우리를 지배하면 '쓸모없는 건축가'가 되지만, 기술이 우리를 돕게 하면 '더 나은 건축가'가 됩니다.<br><br>2부에서 우리는 수많은 갈등과 혼란을 날것 그대로 목격했습니다. 이 부록은 바로 그 혼란의 현장에서, **새로운 디지털 설계 도구**라는 시스템과 그 두뇌인 AI **'아키 시냅스'**가 어떻게 구체적으로 개입하여 인간의 판단을 돕는지에 대한 실제적 기록입니다.",
            "partCategory": "[부록] 시스템의 기록, J-Hub",
