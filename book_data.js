var bookData = {
    "pages": [
        ...
        },
        {
            "type": "bridge",
            "title": "기록의 무게",
            "text": "다음 이어질 70여 편의 에세이는 앞서 고백한 저의 '생속' 같은 마음이 현장에서 어떻게 부딪히고 깨지며, 조금씩 제 마음의 크기를 넓혀가는지를 보여주는 생생한 증거입니다.<br><br>이 글들은 화려한 이론이 현장에서 어떻게 무너지고, 다시 사람과 사람의 온기로 채워지며 '진짜 신뢰'로 거듭나는지를 기록한 찰나들입니다. 여전히 사람 만나는 것이 두렵고 서툰 50대 중반의 건축가가, 현장의 수많은 '좋은 분들'과 부대끼며 맺어가는 이 치열하고 따뜻한 공유결합의 기록들을 지켜봐 주십시오.",
            "partCategory": "1부. 설계의 본질 – 공유결합",
