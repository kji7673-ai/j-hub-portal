var bookData = {
  pages: [
    ...
    {
      type: "cover",
      image: "static/images/act2_open_bg.jpg",
    ...
    },
    {
      ...
      text: "이제 잘 시간입니다.<br>저는 누우면 바로 잠이 듭니다.<br><br>깨어있는 이 순간이나<br>내일 아침 깨어날 시간엔,<br>지나온 것들 속에 잊어야 할 것은<br>온전히 잊었으면 좋겠습니다.<br><br>사람을 대할 때 참 무섭고도 힘든 것은,<br>나도 모르게 '과거의 기억'으로 상대를 단정 짓고 본다는 것입니다.<br>어쩌면 당연한 일인지도 모릅니다. <br>하지만 막상 제가 누군가에게 과거의 잣대로만 비춰질 때면<br>\"오늘은 새로우니 다르게 봐주세요\" 하고 억울해하는 것이<br>또 이기적인 사람의 마음인가 봅니다.<br><br>그래서 다짐해 봅니다.<br>사람을 대할 때는 어제의 선입견을 덮어두고,<br>늘 처음 만나는 사람처럼 반가운 마음으로 마주하겠다고 말입니다.<br><br>오늘을 산다는 것은<br>어제의 눈으로 나의 일상과 사람을 보지 않는 것입니다.<br>익숙해짐으로 스쳐 지나갈 소중한 것들이 참 많이 있습니다.<br><br>오늘도 잠이 듭니다.<br>내일은 사람도, 공간도, 그리고 나 자신도 <br>매일 새롭게 느끼며 살아가야겠습니다.",
    ...
    {
      type: "cover",
      image: "static/images/act3_open_bg.jpg",
    ...
    },
    {
      ...
      partCategory: "제3막: 사람을 알아가는 관계성",
      image: "static/images/sculpture_filter.jpg",
      type: "image_top",
    },
    {
      part: "4부: 증언과 성찰",
    ...
    },
    {
      ...
      image: "static/images/act4_open_bg.jpg",
    },
    {
      part: "4부: 증언과 성찰",
      partTitle: "[Theme 1] 현장에서의 갈등",
