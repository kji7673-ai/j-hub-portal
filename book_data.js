const bookData = {
    "pages": [
        ...
        },
        {
            ...
            "partTitle": "[Theme 1] 현장에서의 갈등",
            "title": "어느 심의 날의 기록",
            "text": "서로 간에 교류와 소통이 없는 현 주거 공간에서, 소통과 주민 간의 접촉점이 자연스럽게 많이 일어날 수 있는 주민 공동시설, 사랑방이나 편의 시설이 있었다면 좀 더 좋게 되었을 것 같은데 말입니다.<br><br>\n너무 가까이 있으면 자기만의 공간을 위해 더욱 닫고 사는 게 사람의 본성인데, 조금은 숫자 놀음으로 건축의 정책이 만들어지지 않았으면 좋겠습니다.<br><br>\n<blockquote>좋은 관계를 위해선 그만큼의 여유 공간이 필요합니다. 서로 잘 지낼 수 있고 소통할 수 있는 공간이 생기는 정책이었다면 얼마나 좋았을까? 다세대마다 특색이 있는 사랑방이 있다면 얼마나 좋았을까? 계단의 참이 휴게 테라스가 되면 얼마나 좋았을까? 이런 생각을 해봅니다.</blockquote><br><br>우리가 법규와 효율(용적률)만을 따지며 콘크리트 벽을 높이는 동안, 어쩌면 우리 이웃과 마음을 나눌 여유 공간마저 스스로 허물어버린 것은 아닐까요? 차가운 숫자 놀음 너머에, 사람이 숨 쉴 수 있는 따뜻한 틈이 허락되기를 바라봅니다.",
            "partCategory": "제4막: 공동체로의 통합, 마음을 짓는 일",
            "image": null,
            "type": "text_only",
            "caption": null,
