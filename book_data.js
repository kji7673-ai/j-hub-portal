var bookData = {
    "pages": [
        ...
        {
            "type": "image_top",
            "title": "공유결합: 사람을 향한 건축, 용산 현장의 기억",
        ...
        },
        {
            ...
            "text": "처음 AI 시스템 구축을 결심했을 때, 나는 흔히 말하는 '코딩의 코 자도 모르는' 전형적인 비개발자였다. 파이썬(Python)의 기본 문법조차 몰랐고, 터미널 창을 여는 것조차 낯설어했다. 아마추어의 섣부른 도전이라는 주변의 만류도 많았다.\n\n![현장 스케치](static/images/32.jpg)\n\n하지만 나는 개발 언어를 모르는 대신, 내가 도달하고자 하는 **'목표'**가 무엇인지 분명하게 알고 있었다.\n\n기계에게 다짜고짜 코드를 짜내라고 요구하는 대신, 내가 구상한 데이터의 흐름과 시스템의 위계를 논리적인 '건축 도면(흐름도)'처럼 펼쳐 보이기 시작했다. 새로운 디지털 설계 도구(통합 대시보드)와 J-Journal(개별 저널)이 어떻게 서로 데이터를 주고받아야 하는지, 사용자가 어떤 순서로 버튼을 누르고 화면을 봐야 하는지, 그 모든 프로세스가 이미 완벽한 건축 설계도처럼 머릿속에 구조화되어 있었다. 코딩은 단지 그 설계도를 번역하는 망치와 톱일 뿐이었다.",
