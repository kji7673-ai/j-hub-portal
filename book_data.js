const bookData = {
    "pages": [
        ...
        },
        {
            "type": "text_only",
            "title": "간격: 그 사이 공간의 힘",
            "text": "다시 한번 사이 공간, 여백, 또는 '거리 두기'에 대해서 이야기를 해볼까요?<br><br>\n앞서 말씀드린 것처럼, 인간의 뇌는 파편화된 정보를 통합하려는 습성이 있습니다. 아담과 신의 손끝이 닿을 듯 말 듯 한 미켈란젤로의 '천지창조'처럼, 적절히 떨어져 있는 간격은 강력한 연결의 에너지를 발생시킵니다.<br><br>\n사람과의 관계도 마찬가지입니다. 적절한 거리 두기와 여백은 각자의 개체성을 뚜렷하게 지켜주며, 나와 상대방 모두에게 건강한 에너지를 줍니다. 여기서 분명히 해야 할 것은, 건강한 관계를 맺기 위해서는 반드시 <strong>'침범받지 않는 자기만의 영역(존엄)'</strong>이 전제되어야 한다는 점입니다.<br><br>\n한때 과학자들은 원자가 더 이상 쪼개지지 않는 꽉 찬 알갱이인 줄 알았습니다. 하지만 그 안을 들여다보니 원자의 대부분은 텅 빈 '공간'이었습니다. 중심을 잡고 있는 원자핵과 그 주위를 도는 전자 사이에는 엄청난 거리의 여백이 존재합니다. 그 거대한 여백이 역설적으로 원자라는 단단한 물질을 유지하게 만듭니다.<br><br>\n우리의 삶도 그렇습니다. 누군가와 결합하기 이전에, 당신은 스스로 충분한 공간(여백)을 가지고 마땅히 존중받아야 하는 존재입니다. 만약 타인으로부터 그 존중을 받기 어렵다면 우리는 끊임없이 거리를 띄워야 합니다. 만약 그 정도의 여백조차 허락하지 않는 억압적인 '틀' 안에 갇혀 있다면, 그 틀을 과감히 벗어나는 것도 훌륭한 방법입니다. 당장 벗어날 수 없다면 본인의 존엄을 지킬 수 있는 또 다른 여백을 필사적으로 찾아내야만 합니다.<br><br>\n크고 작음, 가까이 두기와 멀리 두기. 이 모든 것들이 서로의 존엄을 훼손하지 않는 에너지의 관계망 안에서 조화롭게 머물러야 합니다. 억지로 끼워 맞추는 것이 아니라, 서로를 존중하며 '당연히 있어야 할 곳에 마땅히 있게' 배치하는 것.<br><br>\n참으로 어려운 일입니다. 하지만 이것이 바로 제가 <strong>\"설계는 타고난 감각으로 하는 것이 아니라 성숙함, 즉 사람과 관계를 이해하는 마음의 크기에서 나온다\"</strong>고 단언하는 이유입니다.<br>당신의 존엄을 지키는 단단한 여백 위에서 이루어지는 만남, 그것이 진짜 공유결합입니다.",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 4] 미완의 일상",
            "partCategory": "제1막: 공유결합 디자인 방법론",
