var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "text": "<div style=\"position: relative; width: 100%; overflow: hidden; border-radius: 16px; margin-bottom: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);\">\n  <div style=\"background-image: url('static/images/author_profile.jpg'); background-size: cover; background-position: center 30%; width: 100%; height: 450px;\"></div>\n  <div style=\"position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(to bottom, rgba(0,0,0,0.1) 40%, rgba(0,0,0,0.8) 100%); display: flex; align-items: flex-end; padding: 40px;\">\n    <div>\n      <h2 style=\"color: #ffffff; font-size: 2.2em; font-weight: 700; margin: 0 0 10px 0; letter-spacing: -0.5px;\">김중일</h2>\n      <p style=\"color: rgba(255,255,255,0.8); font-size: 1.1em; margin: 0;\">(주)진양엔지니어링건축사사무소 대표이사</p>\n    </div>\n  </div>\n</div>\n\n26년째 도면 위에서 선을 긋고, 얽히고설킨 정비사업 현장에서 수많은 사람과 부대끼며 살고 있는 평범한 '건축 쟁이'입니다. 젊은 시절엔 대단한 문화를 만들겠다는 낭만적인 꿈도 있었지만, 26년이 지난 지금은 오히려 건축이 무엇인지도 잘 모르는 상태가 된 것 같습니다.<br><br>비록 정답은 여전히 모르지만, 그래도 이제는 '이것이 나의 기준이다'라고 조심스레 말해야 할 것 같아, 오늘도 도면 앞에서 홀로 머리를 싸매는 바보입니다.",
            "title": "김중일 건축사"
        },
        {
            "type": "image_full",
