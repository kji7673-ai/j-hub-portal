var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "text": "26년. 도면 위에서 숱한 선을 그었고, 조형물을 깎아내며, 현장의 진흙탕에서 무수한 사람을 만났습니다.<br><br>처음엔 \"훌륭한 건축\"을 꿈꿨습니다. 위대한 작품, 기념비적인 건물 말입니다. 하지만 지금 깨닫는 것은, 그 모든 것이 결국 사람 사이의 신뢰에서 비롯된다는 것입니다.<br><br>공유결합이란 거창한 이론이 아니었습니다. 세상을 바라볼 나만의 확고한 기준을 세우되, 나의 불완전함을 인정하고 타인의 불완전함을 품으며, 그 둘이 함께 \"조금 나은 무언가\"를 만들어가는 과정 자체였습니다.<br><br>그 융합의 과정 속에서도 타인과의 건강한 거리를 유지하여, 끝내 훼손되지 않을 나만의 개성과 존엄을 지켜가는 것. 그것이 제가 깨달은 공유결합의 진짜 의미입니다.<br><br>이 책을 읽을 후배 건축사들에게 전하고 싶습니다. 당신의 도면이 누군가의 집이 될 것입니다. 그 무거운 책임감 앞에서 흔들리는 것은 약함이 아니라 성숙의 신호입니다.<br><br>그리고 건축과 무관한 독자분들에게 말씀드리고 싶습니다. 우리가 사는 이 세상도 건축과 같습니다. 개인의 영역 안에서 단단하게 서면서도, 밥벌이의 고단함 앞에서는 기꺼이 타인의 온기를 나눌 수 있는 사람이 되길 바랍니다.<br><br>그것이 제가 도면 위에서, 서툴게 깎아낸 조형물 속에서, 그리고 이 세상 속에서 꿈꾸는 가장 완벽한 공유결합입니다. 유명세 없는 평범한 건축 쟁이의 이 거칠고 투박한 기록(글, 스케치, 조형물)들이 하나로 뭉쳐 굳이 세상 밖으로 나와야만 했던 이유이기도 합니다.<br><br>이 책을 읽는 누군가가, 내일 누군가를 대할 때 '저 사람의 불완전함도 내 불완전함처럼 소중한 것 아닐까'라고 생각해 준다면, 저의 26년은 헛되지 않을 것 같습니다. 도면 위에 그었던 모든 선들이, 결국 사람과 사람을 연결하는 선이 되길 바랍니다.<br><br>혹은 누군가에게 그 선이 '내가 혼자가 아니구나'라는 따뜻한 확인이 되어줄 수 있다면, 저의 26년 도면 위의 여정은 이제 당신의 손에서 이어질 것입니다.",
            "partCategory": "에필로그"
        }
    ]
};