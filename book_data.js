var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "text": "제가 왜 '공유결합'이라는 단어를 설계의 중심에 두게 되었는지 고백해야 할 것 같습니다. 제 인생을 관통하는 이 거대한 은유는 전혀 상관없어 보이는 세 번의 우연한 기억에서 시작되었습니다.<br><br>첫 번째는 고등학교 1학년 때 만난 친구 정하진입니다. 어느 날 어머니가 부엌에서 \"진아~\" 하고 부르시자, 하진이는 너무나도 다정하게 \"네~\" 하고 대답했습니다. 대구에서 자란 무뚝뚝한 사내아이들의 퉁명스러운 \"왜!\"만 듣고 자란 제게, 그 짧고 따뜻한 대답은 신선한 충격이었습니다. 누군가의 부름에 저토록 다정하게 응답할 수 있구나. 40년이 지난 지금도 그 \"네~\"라는 울림은 선명합니다.<br><br>두 번째는 대학원 시절이었습니다. 길을 걷다 갑자기 머릿속에 번개가 친 것처럼 \"계단! 그래, 계단이다!\" 하고 소리친 적이 있습니다. 상하를 잇고 단절된 층위를 극복하며 공간의 변화를 이끌어내는 존재. 서로 다른 두 공간을 이어주는 매개체의 벅찬 힘을 깨달은 순간이었습니다.<br><br>마지막 세 번째는 어느 날 듣게 된 저명한 물리학자 교수님의 강연이었습니다. 원소의 결합 방식을 설명하며 '이온 결합'과 '공유결합'이라는 단어를 꺼내신 순간, 제 머릿속에서 과거의 그 다정한 \"네~\"라는 대답과 \"계단\"의 깨달음이 하나로 얽혀 폭발했습니다.<br><br>'아, 우리 몸도 결국 공유결합이구나. 그렇다면 나와 타인, 나와 현장의 관계 역시 하나의 거대한 공유결합이구나.'<br><br>사람은 타인의 부름에 다정하게 응답할 수 있고(네~), 단절된 것들을 연결할 수 있으며(계단), 스스로 세상을 잇는 매개체가 될 수 있습니다.<br>각자의 불완전함을 기꺼이 내어주고 서로를 묶어 안정을 찾는 과정. 그날 이후, '공유결합'은 제 건축과 삶을 지탱하는 유일한 나침반이 되었습니다.",
            "part": "1부: 설계의 본질 - 공유결합",
            "partTitle": "건축이라는 세계",
            "partCategory": "1부. 건축의 뼈대: 도면 위의 철학",
        ...
        {
            "type": "text",
            "title": "공유결합을 지탱하는 세 가지 철학",
            "partCategory": "1부. 건축의 뼈대: 도면 위의 철학",
            "text": "설계는 단지 도면 위에 선을 그리는 행위가 아닙니다.<br>진짜 설계는 다음의 세 가지 철학에서 출발합니다.<br><br>관계 속에서 흔들리지 않는 <strong>'나만의 기준'</strong>을 세우고 본질의 무게를 다지는 것.<br>때로는 나를 철저히 비워냄으로써, 서로 다른 이들의 투박한 언어조차 둥글게 이해하고 껴안을 수 있는 <strong>'여유'</strong>를 갖는 것.<br>그리고 거대한 욕망이 격돌하는 <strong>'진짜 현장(회의 테이블)의 이면'</strong>을 꿰뚫어 보는 것.<br><br>자신의 기준, 타인을 향한 여유, 현장을 보는 통찰.<br>이 세 가지 철학이 하나로 맞물릴 때, 비로소 어떠한 외풍에도 흔들리지 않는 가장 단단한 신뢰, 즉 '공유결합'이 완성됩니다.",
