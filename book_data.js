const bookData = {
    "pages": [
        ...
        },
        {
            ...
            "title": "공유결합의 세 가지 요소",
            "partCategory": "제1막: 공유결합 디자인 방법론",
            "text": "나만의 단단한 기준(기본)을 세우고, 타인을 향한 호기심과 여유를 가졌다면 이제 우리에게 남은 과제는 하나입니다.<br><br>\n각기 다른 환경과 조건을 어떻게 조율하여 '합의된 설계도면'으로 엮어내고, 그 속에서 어떻게 서로를 '공유결합'시킬 것인가. 이것이 수많은 이해관계가 얽힌 정비사업의 핵심입니다.<br><br>\n하지만 이는 비단 도면 위에서만 벌어지는 일이 아닙니다. 사람 관계에서도 마찬가지입니다.<br>자기의 본질을 너무 약하게 가져가면 상대가 존중해 주지 않고, 반대로 여유 없이 뻣뻣하기만 하면 관계는 쉽게 부러집니다. 나와 타인이 적절한 관계성을 유지하며 서로의 빈 곳을 공유할 때, 비로소 흔들리지 않고 안정화될 수 있습니다.<br><br>\n우리가 도면과 현장에서 마주해야 할 <strong>결합의 세 가지 요소</strong>를 다시 한번 정리하자면 이렇습니다.<br><br>\n관계 속에서 흔들리지 않는 <strong>'나만의 기준'</strong>,<br>\n서로 다른 언어를 껴안는 <strong>'여유'</strong>,<br>\n그리고 이를 조율하여 합의를 이끌어내는 <strong>'현장을 보는 시선'</strong>입니다.<br><br>\n이 세 가지 요소가 단단히 맞물릴 때, 비로소 어떠한 외풍에도 흔들리지 않는 가장 안정적인 상태, 즉 '공유결합'이 완성됩니다.",
            "image": null,
            "caption": null,
            "isTextAfterImage": true,
            "isContinuation": false,
        ...
        },
        {
            ...
            "partTitle": "[Theme 1] 현장에서의 갈등",
            "title": "페이퍼 아키텍처의 유혹",
            "text": "설계를 하다 보면 페이퍼 아키텍처(Paper Architecture)라는 것이 있습니다.<br>건축 설계가 시공까지 가지 않은 순수 계획안 상태를 의미하기도 하지만, 보통은 디테일이나 현실감이 턱없이 부족할 때 이 단어를 사용합니다.<br><br>삶에서 말과 실체가 일치하지 않을 때, 흔히 '입만 살았다'고 하는 것과 비슷합니다.<br><br>설계나 삶이나 좀 더 깊이 생각하고, 무엇이 진실에 가까운지 늘 돌아봐야 합니다.<br>제가 옳다고 생각하는 것, 그리고 남들도 그렇게 이해해 주리라 믿어버리는 것은 그저 자신만의 소설을 쓰는 것에 불과합니다. 설계를 할 때도 마찬가지입니다.<br><br>자신의 도면이 현실의 비바람을 견뎌낼 수 있는 진짜 건축물인지, 아니면 그저 종이 위에 머무는 헛된 상상인지 끊임없이 묻고 경계해야 합니다.",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
            "image": null,
            "type": "text_only",
            "caption": null,
