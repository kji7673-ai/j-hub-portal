const bookData = {
    "pages": [
        ...
        },
        {
            ...
            "title": "땅과 사람이 하는 말에 귀 기울이는 법",
            "image": null,
            "text": "도면 위에 웬 '존중'이냐며 고개를 갸우뚱하실지도 모르겠습니다. 하지만 한 폭의 그림을 그릴 때를 떠올려 보십시오. 화가는 자신이 돋보이게 하고 싶은 주제를 위해 상하좌우의 무게감을 조절하고 여백을 안배합니다. 이는 종이 위의 물감조차도 서로 다투지 않도록 '배려'하고 '존중'하는 행위입니다.<br><br>\n건축도 마찬가지입니다. 도면 위의 선 하나, 재질 하나조차 각자의 위치에서 고유의 숨 쉴 공간을 존중받아야 합니다.<br><br>\n저는 각 디자인 요소들에게 <strong>\"네가 서고 싶은 자리가 어디니?\"</strong> 하고 묻고, 그들의 목소리에 귀를 기울이려 애씁니다. 너무 작은 요소라 하여 소홀히 취급해서도 안 됩니다.<br>만약 그 개체성을 잃을 것 같다면 아예 거대한 흐름 속에 자연스럽게 포함시키거나, 반대로 색상이나 재질을 극대화하여 훨씬 더 강렬한 특성을 부여해야만 서로가 상처받지 않고 공존할 수 있습니다.",
            "part": "제2막: 철학편",
            "partTitle": "시스템 너머의 본질",
            "partCategory": "제1막: 공유결합 디자인 방법론",
            "caption": null,
