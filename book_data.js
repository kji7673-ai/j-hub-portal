var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "text": "기술은 우리가 신는 신발을 훨씬 편하게 개선해 주었지만, 결국 어느 방향으로 걸어갈지는 여전히 사람이 결정해야 합니다.\n\n미래의 설계 도구가 아무리 완벽한 기록를 제공하더라도, 건축을 최종적으로 완성하는 것은 인간의 불완전하지만 따뜻한 결단입니다. 오랜 시간의 경험에서 얻은 진짜 깨달음은, 기술이 우리를 흠결 없는 완벽한 존재로 만들어 주는 것이 아니라는 점이었습니다. 오히려 기술은 우리의 불완전함을 겸허히 받아들이게 하고, 타인에 대한 공감과 책임감이라는 도구가 할 수 없는 영역에 집중하게 함으로써 우리를 더욱 '인간다운 건축가'로 만들어 줍니다.\n\n내일 아침 현장에 가면, 저는 여전히 투박한 손으로 도면 위에 선을 긋고, 의심 가득한 조합원의 손을 잡고 설득할 것입니다. 새로운 도구는 내 손가락을 대신 움직여 도면을 그려주지 않습니다. 다만, 나의 복잡한 계산을 덜어주어, 그들의 손을 맞잡고 설득할 귀중한 '인간의 시간'을 벌어줄 뿐입니다.\n\n처음 현장의 진흙탕을 누비며 밑창이 다 떨어져 나갔던 그 '찢어진 운동화'의 기억이 떠오릅니다. 그때는 그저 살아남고 버티기 위해 신발 끈을 꽉 동여맸다면, 이제는 가장 날카로운 무기인 새로운 새로운 도구를 등에 업고 다시 한번 먼지 묻은 신발 끈을 고쳐 맵니다.\n\n기술이 내 운동화의 닳은 밑창을 두껍게 만들어주진 못하겠지만, 적어도 내가 딛는 걸음마다 흔들리지 않는 이정표가 되어줄 것입니다. 찢어진 운동화에서 시작된 이 불완전한 여정의 끝이, 온전히 사람의 냄새로 가득 찬 공간이 되기를 기원하며 현장으로 문을 나섭니다.",
            "partCategory": "에필로그",
            "image": "static/images/sketches/116.jpg"
        },
        {
        ...
        },
        {
            "type": "chapter_content",
            "title": "불완전함을 설계하다",
            "text": "완벽한 도구은 때로 가장 위험한 함정이 됩니다. 모든 것을 숫자로 치환하고 날것 그대로 투명하게 공개하려는 시도는, 오히려 현장 사람들의 불안을 자극하고 신뢰를 파괴하기도 합니다.<br><br>따라서 기술은 '선택적 투명성'이라는 윤리적 경계를 가져야 합니다. 우리가 제시하는 새로운 도구의 개념은, 도구가 산출한 수만 가지의 차가운 확률 기록를 그대로 현장에 던지는 것이 아닙니다.<br><br>차가운 계산 결과를 건축가의 철학과 책임감이라는 필터를 통해 한 번 걸러내어, 사람에게 가장 필요한 온도로 전달하는 것. 기술의 완벽함 속에 인간의 불완전함을 수용할 수 있는 여백을 두는 것. 이것이 진정한 미래 도구의 설계입니다.",
