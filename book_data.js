var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "partTitle": "[Theme 4] 미완의 일상",
            "title": "혹시 무겁지 않나요?",
            "text": "<div class=\"poem-style-applied\" style=\"font-size: 0.9em; line-height: 1.45; letter-spacing: -0.04em; padding-top: 10px;\">\n서울 올라와<br>지금까지 언덕 위에 집을 얻어 살아왔습니다.<br>언덕 위 집은 꿈에 그리던 그런 집이 아닙니다.<br>집으로 올라가는 길이 가팔라 천천히 걷게 됩니다.<br><br>천천히 걸으며<br>저 밑에서의 먼지를 털어냅니다.<br>그렇게 집으로 갑니다.<br><br>가끔은 언덕길 가로등에<br>길게 늘어진 제 그림자가<br>유난히 무거워 보일 때가 있습니다.<br><br>잠시 쉬어 가라 하는 것도 같습니다.<br>내 그림자가 이토록 무거워질 때,<br>그럴 땐 저는 어떻게 해야 할까요?\n</div>",
            "image": null,
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
            "type": "poem",
            "caption": null,
        ...
        },
        {
            ...
            "partTitle": "[Theme 1] 현장에서의 갈등",
            "title": "페이퍼 아키텍처의 유혹",
            "text": "<div class=\"poem-style-applied\" style=\"font-size: 0.9em; line-height: 1.45; letter-spacing: -0.04em; padding-top: 10px;\">\n설계를 하다 보면 페이퍼 아키텍쳐라는 것이 있다<br>건축 설계가 시공까지 가지 않은 순수계획안 상태를 의미하기도 하지만,<br>보통은 디테일이나 현실감이 부족한 것을 말할 때 이 단어를 사용한다<br><br>삶에서 말과 삶의 실체가 일치하지 않을 때,<br>흔히 입만 살았다고 하는 것과 비슷하다<br><br>설계나 삶이나 좀 더 생각하고, 무엇이 진실에 가까운지 잘 돌아봐야 합니다<br> 제가 옳다고 생각하는 것, 그리고 그렇게 이해되리라 생각하는 것은<br>자신만의 소설을 쓰는 것이다<br>설계를 할 때도 같다<br><br>자신의 생각이 그대로 읽혀지리라는 것은 소설 쓰는 것이다<br>허구일 수 있다, 자신의 머릿속에서만 존재하는.<br><br>첫 직장의 소장님이 자주 하시던 잔소리였다<br><strong style=\"color: #0066cc;\">\"소설 쓰지 마라. 그리고 그게 진실인지 파악해라.\"</strong>\n</div>",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
            "image": null,
            "type": "image_top",
            "caption": null,
