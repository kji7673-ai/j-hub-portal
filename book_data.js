    ...
    "pages": [
        {
            "partCategory": "저자 소개",
            "title": "김중일",
            "text": "건축을 업으로 삼고 수많은 나날 동안 도면 위에 선을 그어왔습니다. 어쩌면 그 선들이 종이 위에서도, 사람과의 관계 속에서도 서로를 잇는 연결의 선이 될 때도 있었고, 때론 뼈아픈 단절의 선이 될 때도 있었습니다.<br><br>졸업을 하고 처음 도면을 펼칠 때만 해도 '유명한 건축가'가 되고 싶었고, 번듯한 '작품집'도 내고 싶었습니다. 하지만 세상살이를 버텨내고 현장의 흙먼지를 뒤집어쓰며 깨달은 것은, 위대한 건축이나 거창한 이론보다 앞서는 것이 바로 '사람 사이의 신뢰'라는 사실이었습니다.<br><br>오늘도 묵묵히 도면 위에서, 그리고 현장에서 사람과 공간이 맺는 '공유결합'의 단단한 비례를 찾아가고 있는 평범한 건축사입니다."
        },
        {
            "type": "image_top",
        ...
        },
        {
            ...
            "text": "도면 위에 그었던 그 모든 선들이, 결국 사람과 사람을 연결하는 선이 되길 진심으로 바랍니다.<br><br>\n혹은 누군가에게 그 선이 '내가 혼자가 아니구나'라는 따뜻한 확인이 되어줄 수 있다면, 도면 위에서 이어온 저의 여정은 이제 당신의 손에서 아름답게 이어질 것입니다.",
            "partCategory": ""
        },
        {
            "type": "author_profile",
