const bookData = {
    "pages": [
        ...
        },
        {
            ...
            "subtitle": "",
            "image": null,
            "text": "건축을 하며 수없이 많은 날 동안 무수한 선을 그었습니다.<br>종이 위에서 그었던 그 선들은 어떨 때는 사람과 사람을 잇는 '연결의 선'이 되기도 했고, 어떨 때는 저를 지독한 '외톨이로 만드는 선'이 되기도 했습니다.<br><br>처음 졸업하고 직장 생활을 시작할 때만 해도, 저 역시 남들처럼 유명한 건축가가 되고 싶었고 번듯한 작품집도 내고 싶었습니다.<br>하지만 현실은 그저 분주한 세상살이를 버텨내는 것만으로도 힘겨웠습니다.<br><br>애초에 이 책은 어떤 대단한 의도나 대단한 이론을 남기고자 시작한 것이 아닙니다.<br>그저 도면 밖의 현실에서 짊어져야 했던 삶의 무게와 정체성의 혼란, 사람과의 관계 속에서 겪었던 뼈아픈 갈등들을 가슴에 담아두기가 너무 힘겨워, 마음속에 맺힌 것들을 하나씩 덜어내는 심정으로 적어 내려간 글들입니다.",
            "part": "제1막: 프롭테크와 정비사업의 미래",
            "partCategory": "저자 소개",
            "caption": null,
            "isTextAfterImage": true,
        ...
        },
        {
            ...
            "subtitle": "",
            "image": null,
            "text": "그렇게 맺힌 마음을 덜어내며 묵묵히 버티다 보니, 비로소 흔들리지 않는 기준 하나를 붙잡게 되었습니다.<br>그것이 바로 **'공유결합'**입니다.<br><br>이 단어는 제가 설계하며 만나는 사람과 상황, 그리고 수많은 계획안을 풀어내는 저만의 해답이 되었습니다.<br>동료나 후배분들도 이미 현장에서 몸으로 다 알고 계실 내용이겠지만, 우리가 꾸준하게 버텨낸 이 과정들이 누군가에게는 작은 위로와 길잡이가 되었으면 하는 마음에 용기를 내어 세상에 꺼내어 봅니다.<br><br>이 책은 건축에 관한 이야기이자, 동시에 당신의 삶과 관계에 관한 이야기입니다.<br>딱딱한 콘크리트와 차가운 법규 사이에서 사람들이 어떻게 부대끼며 살아가는지, 그 안에서 우리는 타인과 어떤 선을 긋고 살아야 하는지… 그 해답을 제 삶의 궤적이 담긴 도면 위에서 함께 찾아보려 합니다.",
            "part": "제1막: 프롭테크와 정비사업의 미래",
            "partCategory": "저자 소개",
            "caption": null,
            "isContinuation": true,
