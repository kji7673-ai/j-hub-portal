var bookData = {
    "pages": [
        ...
        },
        {
            "type": "image_top",
            "title": "찢어진 운동화",
            "text": "자신의 아파트를 설계하는 사람에게 대뜸 반말부터 던지는 저 무지함은 대체 뭘까?<br><br>\n그런 무례함에 아직도 속절없이 휘둘리는 제 모습이 한없이 작아 보였습니다. <br>일단 무너진 마음을 추스를 시간이 필요했기에, <br>대충 핑계를 대고 서둘러 그 자리를 빠져나왔습니다. <br><br>\n도면 위에서 요소들이 충돌할 때 '간격'을 벌려야 하듯, <br>사람 사이에도 감정이 날카롭게 부딪힐 땐 적당한 거리와 여백이 필요하니까요.<br><br>\n그렇게 도망치듯 나와 걷던 중, <br>문득 제 눈에 들어온 것은 앞코가 찢어진 낡은 프로스펙스 운동화였습니다.<br><br>제1막에서 이야기했듯, 사람들은 거대한 바탕보다 숨기고 싶은 '작은 흠결'에 유독 날카롭게 시선을 꽂기 마련입니다. <br>어쩌면 그 사람의 눈에는 제가 밤새워 그려간 도면이라는 거대한 바탕보다, 발끝에 놓인 후줄근하고 찢어진 운동화라는 작은 흠결이 먼저 보였을지도 모릅니다. <br>그 찢어진 틈새가 부끄러워지는 순간, 이 낡은 운동화가 곧 초라한 제 모습 같아 당장이라도 벗어 던지고 싶었습니다.",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 1] 현장에서의 갈등",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
