var bookData = {
    "pages": [
        ...
        },
        {
            "type": "image_top",
            "title": "찢어진 운동화 (계속)",
            "text": "<div style=\"margin-top: 40px; padding: 24px; background-color: #f5f5f7; border-radius: 12px; color: #333333; font-size: 15px; line-height: 1.6; border-left: 3px solid #333333;\">건축이란 화려한 조감도나 흙먼지 날리는 현장 속에서만 완성되는 것이 아닙니다. 진짜 건축 설계는 사람과 사람의 '만남'에서 시작되며, 그 만남을 어떻게 좋은 관계로 엮어 가느냐에 달려 있습니다.<br><br><br>",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 1] 현장에서의 갈등",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "마음을 짓는 일: 공동체 주택 설계 (계속)",
            "text": "<br><br>전혀 다른 삶의 방식을 가진 가족들이 하나의 지붕 아래 모여 살기 위해서는, 역설적으로 서로의 경계를 명확히 지켜주는 <strong>'단단한 틀(건축적 뼈대)'</strong>이 필수적이었습니다. 각 세대의 고유한 개성(색상)이 충돌하지 않도록 건축가가 몬드리안의 검정 선처럼 안정된 제도의 테두리를 그어주었을 때, 그들은 비로소 진정한 의미의 공동체로 결합할 수 있었습니다.",
            "image": null,
            "partCategory": "제4막: 공동체로의 통합, 마음을 짓는 일",
            "type": "image_top",
            "caption": null,
