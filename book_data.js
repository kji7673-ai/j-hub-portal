var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "partTitle": "[Theme 2] 인간관계의 무게",
            "title": "요즘 잠을 잘 수가 없다",
            "text": "<div style=\"text-align: center; max-width: 500px; margin: 0 auto;\">\n<p style=\"text-align: left; line-height: 1.85; font-size: 1.1em; color: #333; margin-top: 40px; margin-bottom: 60px; display: inline-block;\">\n요즘 저는 잠을 잘 수가 없습니다.<br>눈을 감으면,<br>저의 모든 감각 기관이 더욱 예민해집니다.<br>어느 날은 자고 있는 상태에서도 제 옆에 기어가는 벌레를 인지하고 잡은 적도 있습니다.<br>심지어<br>지는 눈을 뜨고 잡니다.<br>자고 있는 제게 말을 붙이면 대답을 합니다.<br>군에서는 선임들이 제 머리카락만 건드려도 관등성명을 댄다고 모두들 신기해했지만,<br>사실 저는 자면서도 그들의 모든 일거수일투족을<br>인지하고 있었습니다.<br>저의 이 능력은 사실 지네에게 물렸을 때 생긴 능력입니다.<br>거미에 물렸다면 스파이더맨이 될 수도 있었는데 아깝습니다.<br>아무튼, 저는 지네맨이 되었습니다.<br>지네가 가진 예민한 촉각을 제가 가지게 된 것입니다.<br>몹시 예민합니다.<br>이런 능력을 가진 후 몇 가지 단점도 생겼습니다.</div></p>",
            "partCategory": "제2막: 나라는 개체의 독립과 생존",
            "image": null,
            "type": "poem",
            "caption": null,
