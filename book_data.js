    ...
    "pages": [
        {
            ...
            "text": "<div style=\"width: 100%; max-width: 600px; margin: 0 auto 60px auto; background-color: #fafafc; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.08); display: flex; flex-direction: column; position: relative;\">\n    <!-- Image Container (object-position: top center ensures head is never cut off) -->\n    <div style=\"width: 100%; height: 500px; overflow: hidden; background-color: #f5f5f7;\">\n        <img src=\"static/images/bond_4.jpg\" style=\"width: 100%; height: 100%; object-fit: cover; object-position: center 10%; display: block;\" alt=\"도면 위의 공유결합 조형물\">\n    </div>\n    \n    <!-- Title / Author Container -->\n    <div style=\"padding: 48px 32px; text-align: center; background-color: #ffffff; position: relative;\">\n        <!-- Subtle graphic line -->\n        <div style=\"position: absolute; top: 0; left: 50%; transform: translateX(-50%); width: 40px; height: 3px; background-color: #1d1d1f;\"></div>\n        \n        <h4 style=\"font-size: 0.85em; color: #888; letter-spacing: 3px; margin-bottom: 20px; font-weight: 600;\">J-JOURNAL</h4>\n        <h1 style=\"font-size: 2.4em; font-weight: 700; color: #1d1d1f; margin-bottom: 16px; letter-spacing: -1px; word-break: keep-all; line-height: 1.2;\">도면 위의<br>공유결합</h1>\n        <h2 style=\"font-size: 1.05em; color: #666; margin-bottom: 40px; font-weight: 400; word-break: keep-all; line-height: 1.6;\">건축가의 도면 위에서 피어난,<br>차갑고도 뜨거운 사람의 기록</h2>\n        <p style=\"font-size: 1em; color: #1d1d1f; font-weight: 700; margin: 0; letter-spacing: 1px;\">김중일 지음</p>\n    </div>\n</div>"
        },
        {
            "type": "author_profile",
            "image": "static/images/sketches/13.jpg",
            "text": "<div style=\"position: relative; width: 100%; border-radius: 16px; overflow: hidden; padding: 80px 40px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); min-height: 500px; display: flex; align-items: center; justify-content: center; background-color: #fafafc;\">\n    <!-- Background Image with Blur and Opacity -->\n    <div style=\"position: absolute; top: -10px; left: -10px; right: -10px; bottom: -10px; background-image: url('static/images/author_profile.jpg'); background-size: cover; background-position: center 30%; filter: grayscale(100%) blur(8px); opacity: 0.15; z-index: 1;\"></div>\n\n    <!-- Foreground Content -->\n    <div style=\"position: relative; z-index: 2; text-align: center; max-width: 600px;\">\n        <h2 style=\"font-size: 2em; font-weight: 700; color: #1d1d1f; margin-bottom: 8px; letter-spacing: -0.5px;\">김중일</h2>\n        <p style=\"font-size: 1.05em; color: #555; margin-bottom: 40px; font-weight: 600;\">(주)진양엔지니어링건축사사무소 대표이사</p>\n        \n        <p style=\"font-size: 1.15em; line-height: 1.8; color: #222; word-break: keep-all; margin-bottom: 24px; text-align: left;\">\n        26년째 도면 위에서 선을 긋고, 얽히고설킨 정비사업 현장에서 수많은 사람과 부대끼며 살고 있는 평범한 '건축 쟁이'입니다. 젊은 시절엔 대단한 문화를 만들겠다는 낭만적인 꿈도 있었지만, 26년이 지난 지금은 오히려 건축이 무엇인지도 잘 모르는 상태가 된 것 같습니다.\n        </p>\n        <p style=\"font-size: 1.15em; line-height: 1.8; color: #222; word-break: keep-all; margin: 0; text-align: left;\">\n        비록 정답은 여전히 모르지만, 그래도 이제는 '이것이 나의 기준이다'라고 조심스레 말해야 할 것 같아, 오늘도 도면 앞에서 홀로 머리를 싸매는 바보입니다.\n        </p>\n    </div>\n</div>",
            "title": "김중일 건축사"
        },
        {
            "type": "image_full",
        ...
        },
        {
            ...
            "text": "이 장에 담긴 수십 편의 조각들은 정제되지 않은 날것의 기록입니다.<br><br>이 거칠고 솔직한 기록들에는 머릿속 생각과 현실 사이의 치열한 모순이 있고, 똑같은 고민이 무의식적으로 반복되는 흔적이 있으며, 때로는 깊은 혼란과 무기력함마저 묻어 있습니다.<br><br>앞선 장에서 '공유결합'이라는 거창한 원칙을 이야기했지만, 사실 처음부터 제 삶이 그 원칙대로 완벽하게 맞물려 돌아갔던 것은 아닙니다. 도면 위에서는 완벽한 공유결합의 기준을 맞추려 그토록 치열하게 애쓰면서도, 제 실제 삶과 사람 사이의 공유결합은 여전히 풀기 어려운 숙제입니다.<br><br>그래서, 저는 여전히 불안하고 여전히 부족한 사람입니다.<br><br>중복과 모순, 황홀함과 분노가 모두 얽혀있는 이 조각들은 지난 오랜 세월 제가 끄적이며 써 내려온 생채기 같은 흔적들입니다. 이 작고 투박한 흔적들이, 이 글을 읽는 분들의 마음에도 작은 공명을 일으키기를 바랍니다.",
            "part": "4부: 증언과 성찰",
            "partTitle": "현장의 기록",
            "partCategory": "2부. 삶의 뼈대: 현장의 공유결합"
        },
