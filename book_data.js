var bookData = {
    "pages": [
        ...
        },
        {
            ...
            "text": "세상을 바라볼 나만의 확고한 기준을 세우는 일.<br>동시에 타인을 기꺼이 받아들일 수 있는 넉넉한 여유로움을 품는 일.<br><br>하지만 그 융합의 과정 속에서도 타인과의 건강한 거리를 유지하여, 끝내 훼손되지 않을 나만의 개성과 존엄을 지켜가는 것.<br><br>지난 26년, 도면 위에서 숱한 선을 긋고 무수한 현장의 진흙탕을 뒹굴며 제가 깨달은 '공유결합'의 진짜 의미는 바로 이것이었습니다.<br><br>건축은 결국 사람을 짓는 일입니다.<br>밥벌이의 고단함 앞에서도 매일 조금씩 서로의 결핍을 채워주며, 우리의 삶이 따뜻한 온기로 지어지기를 바랍니다.<br><br>그것이 제가 도면 위에서, 그리고 이 세상 속에서 꿈꾸는 가장 완벽한 공유결합입니다.",
            "partCategory": "에필로그"
        }
    ]
};