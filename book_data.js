const bookData = {
    "pages": [
        ...
        },
        {
            "type": "text_only",
            "title": "100년의 기억을 덮는다는 것",
            "text": "첨예하게 대립하는 상인들의 생존권과 관청의 행정적 잣대 사이에서, 건축가는 어느 한쪽의 손을 들어주는 대신 모두가 공존할 수 있는 <strong>'제도적 프레임'</strong>을 설계해야 했습니다. <blockquote class=\"custom-quote\">\n<strong>\"복잡한 욕망들이 어긋나지 않고 하나의 틀 안에서 안착할 때, 도면 밖의 거친 현장에서도 마침내 공유결합은 완성됩니다.\"</strong>\n</blockquote>\n<div class=\"footnote-box\">\n<strong>* 공유결합 (사회적 의미)</strong>: 생존권, 수익성, 행정 규제 등 서로 충돌하는 복잡한 욕망들이 타협점을 찾아 하나의 제도적 프레임 안에서 평화롭게 공존하는 상태를 뜻합니다.\n</div>",
            "image": null,
            "part": "제4막: 증언과 성찰",
            "partTitle": "[Theme 2] 인간관계의 무게",
            "partCategory": "제4막: 공동체로의 통합, 마음을 짓는 일",
