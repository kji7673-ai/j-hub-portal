var bookData = {
    "pages": [
        ...
        {
            "type": "interlude",
            "title": "2단계: 사람을 알아가는 시간",
            "text": "영화나 드라마 속 건축가는 우아하게 스케치를 하지만, 현실의 설계자는 그리 멋지지 않습니다.<br><br>\n도면 위에서는 완벽한 '공유결합'을 꿈꾸지만, 실제로는 먹고사는 문제 앞에서 매일 부딪히고 흔들리는 평범한 사람일 뿐입니다.<br><br>\n그저 수많은 실패와 좌절, 그리고 극복… 아니, <b>'버티는' 시간</b>을 통과하며 조금씩 더 사람다워지는 과정을 도면 위에 묵묵히 담아내는 사람일 뿐입니다.",
            "partCategory": "2부. 삶의 뼈대: 현장의 공유결합",
