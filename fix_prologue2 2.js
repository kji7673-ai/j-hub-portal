...
const newText1 =
  "<p style=\"margin-bottom: 24px;\">이 책은 <strong>'건축이라는 치열한 세계에서 쟁이로 살아남는다는 것은 과연 무엇인가'</strong>에 대해 저의 후배들에게, 그리고 언젠가 이 글을 읽게 될 <strong>내 아들에게 전해주고 싶은 이야기</strong>입니다.</p>";
